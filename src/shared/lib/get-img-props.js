 ...
 */
export function getImgProps(_a, _state) {
    var { src, sizes, unoptimized = false, priority = false, loading, className, quality, width, height, fill = false, style, onLoad, onLoadingComplete, placeholder = 'empty', blurDataURL, fetchPriority, layout, objectFit, objectPosition, lazyBoundary, lazyRoot } = _a, rest = __rest(_a, ["src", "sizes", "unoptimized", "priority", "loading", "className", "quality", "width", "height", "fill", "style", "onLoad", "onLoadingComplete", "placeholder", "blurDataURL", "fetchPriority", "layout", "objectFit", "objectPosition", "lazyBoundary", "lazyRoot"]);
    ...
    if ('allSizes' in c) {
        ...
        config = Object.assign(Object.assign({}, c), { allSizes, deviceSizes });
    }
    ...
    if (isDefaultLoader) {
        ...
        loader = (obj) => {
            const { config: _ } = obj, opts = __rest(obj, ["config"]);
    ...
    if (layout) {
        ...
        if (layoutStyle) {
            style = Object.assign(Object.assign({}, style), layoutStyle);
        }
  ...
  Read more: https://nextjs.org/docs/messages/export-image-api`);
    ...
    if (process.env.NODE_ENV === 'development') {
        if (placeholderStyle.backgroundImage &&
            placeholder === 'blur' &&
            (blurDataURL === null || blurDataURL === void 0 ? void 0 : blurDataURL.startsWith('/'))) {
    ...
    const props = Object.assign(Object.assign({}, rest), { loading: isLazy ? 'lazy' : loading, fetchPriority, width: widthInt, height: heightInt, decoding: 'async', className, style: Object.assign(Object.assign({}, imgStyle), placeholderStyle), sizes: imgAttributes.sizes, srcSet: imgAttributes.srcSet, src: imgAttributes.src });
