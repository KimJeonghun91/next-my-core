    ...
    try {
        ...
        const flattenKeys = (obj, prefix = '') => {
            ...
            for (const key in obj) {
                if (typeof (obj === null || obj === void 0 ? void 0 : obj[key]) === 'undefined') {
                    continue;
                }
        ...
        const getDeepValue = (obj, keys) => {
            ...
            if (keys.length === 1) {
                return obj === null || obj === void 0 ? void 0 : obj[keys === null || keys === void 0 ? void 0 : keys[0]];
            }
            return getDeepValue(obj === null || obj === void 0 ? void 0 : obj[keys === null || keys === void 0 ? void 0 : keys[0]], keys.slice(1));
        };
        ...
        for (const key of customKeys) {
            ...
            let isUnsupported = unsupportedKeys.some((unsupportedKey) => 
