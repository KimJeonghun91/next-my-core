...
function getFormattedLinkDiagnosticMessageText(diagnostic) {
    ...
    if (typeof message === 'string' && diagnostic.code === 2322) {
        const match = message.match(/Type '"(.+)"' is not assignable to type 'RouteImpl<.+> \| UrlObject'\./) ||
        ...
        if (match) {
            ...
            const relatedMessage = (_b = (_a = diagnostic.relatedInformation) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.messageText;
            if (typeof relatedMessage === 'string' &&
                relatedMessage.match(/The expected type comes from property 'href' which is declared here on type 'IntrinsicAttributes & /)) {
        ...
        const match = message.match(/Type '"(.+)"' is not assignable to type 'RouteImpl<.+> \| UrlObject'\. Did you mean '"(.+)"'?/) ||
        ...
        switch (message.code) {
            case 2344:
                ...
                if (invalidParamFn) {
                    ...
                    if ('next' in message)
                        main += processNextItems(1, message.next);
                    return main;
                }
...
function getAppEntrySourceFilePath(baseDir, diagnostic) {
    var _a, _b;
    const sourceFilepath = ((_b = (_a = diagnostic.file) === null || _a === void 0 ? void 0 : _a.text.trim().match(/^\/\/ File: (.+)\n/)) === null || _b === void 0 ? void 0 : _b[1]) || '';
...
export function getFormattedDiagnostic(ts, baseDir, distDir, diagnostic, isAppDirEnabled) {
    ...
    const isLayoutOrPageError = isAppDirEnabled &&
        ((_a = diagnostic.file) === null || _a === void 0 ? void 0 : _a.fileName.startsWith(path.join(baseDir, distDir, 'types')));
    let message = '';
    ...
    const appReason = !linkReason && isLayoutOrPageError && appPath
