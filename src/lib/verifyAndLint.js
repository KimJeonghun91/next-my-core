...
export async function verifyAndLint(dir, cacheLocation, configLintDirs, enableWorkerThreads, telemetry) {
    try {
        ...
        const lintDirs = (configLintDirs !== null && configLintDirs !== void 0 ? configLintDirs : ESLINT_DEFAULT_DIRS).reduce((res, d) => {
        ...
        if (typeof lintResults !== 'string' && (lintResults === null || lintResults === void 0 ? void 0 : lintResults.eventInfo)) {
            telemetry.record(eventLintCheckCompleted(Object.assign(Object.assign({}, lintResults.eventInfo), { buildLint: true })));
        }
