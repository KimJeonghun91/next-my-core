...
export function createMetadataComponents({ tree, pathname, searchParams, trailingSlash, getDynamicParamFromSegment, appUsingSizeAdjustment, errorType, }) {
    ...
    async function MetadataTree() {
        ...
        let error;
        const errorMetadataItem = [null, null, null];
        ...
        if (appUsingSizeAdjustment)
            elements.push(_jsx("meta", { name: "next-size-adjust" }));
