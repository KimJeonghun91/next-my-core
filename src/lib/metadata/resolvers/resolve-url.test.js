...
describe('metadata: resolveUrl', () => {
    ...
    it('should return url itself when metadataBase is null or url is valid URL', () => {
        ...
        expect(resolveUrl(new URL('https://example.com/def'), null)).toEqual(new URL('https://example.com/def'));
    });
    ...
    it('should ignore metadataBase when url is valid URL', () => {
        const metadataBase = new URL('https://example.com/abc');
        expect(resolveUrl('https://example.com/def', metadataBase)).toEqual(new URL('https://example.com/def'));
        expect(resolveUrl(new URL('https://bar.com/ghi'), metadataBase)).toEqual(new URL('https://bar.com/ghi'));
    });
});
