...
export const resolveThemeColor = (themeColor) => {
    ...
    (_a = resolveAsArrayOrUndefined(themeColor)) === null || _a === void 0 ? void 0 : _a.forEach((descriptor) => {
...
function resolveCanonicalUrl(urlOrDescriptor, metadataBase, metadataContext) {
    if (!urlOrDescriptor)
        return null;
    const url = typeof urlOrDescriptor === 'string' || urlOrDescriptor instanceof URL
        ? urlOrDescriptor
        : urlOrDescriptor.url;
...
export const resolveAppleWebApp = (appWebApp) => {
    ...
    const startupImages = appWebApp.startupImage
        ? (_a = resolveAsArrayOrUndefined(appWebApp.startupImage)) === null || _a === void 0 ? void 0 : _a.map((item) => typeof item === 'string' ? { url: item } : item)
        : null;
    return {
