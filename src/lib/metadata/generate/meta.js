...
export function Meta({ name, property, content, media, }) {
    if (typeof content !== 'undefined' && content !== null && content !== '') {
        return (_jsx("meta", Object.assign({}, (name ? { name } : { property }), (media ? { media } : undefined), { content: typeof content === 'string' ? content : content.toString() })));
    }
    return null;
}
...
function ExtendMeta({ content, namePrefix, propertyPrefix, }) {
    ...
    return MetaFilter(Object.entries(content).map(([k, v]) => {
        return typeof v === 'undefined'
            ? null
            : Meta(Object.assign(Object.assign(Object.assign({}, (propertyPrefix && { property: getMetaKey(propertyPrefix, k) })), (namePrefix && { name: getMetaKey(namePrefix, k) })), { content: typeof v === 'string' ? v : v === null || v === void 0 ? void 0 : v.toString() }));
    }));
}
export function MultiMeta({ propertyPrefix, namePrefix, contents, }) {
    ...
    return MetaFilter(contents.map((content) => {
        if (typeof content === 'string' ||
            ...
            return Meta(Object.assign(Object.assign({}, (propertyPrefix
