...
export class Span {
    constructor({ name, parentId, attrs, startTime, }) {
        this.name = name;
        this.parentId = parentId !== null && parentId !== void 0 ? parentId : defaultParentSpanId;
...
export const trace = (name, parentId, attrs) => {
...
export const exportTraceState = () => ({
    defaultParentSpanId,
    lastId: count,
    shouldSaveTraceEvents,
});
export const initializeTraceState = (state) => {
    count = state.lastId;
...
export function recordTraceEvents(events) {
