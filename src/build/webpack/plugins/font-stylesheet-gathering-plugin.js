...
function isNodeCreatingLinkElement(node) {
    ...
    return ((callee.name === '_jsx' || callee.name === '__jsx') &&
            ...
            for (const type of JS_TYPES) {
                factory.hooks.parser
                    ...
                    parser.hooks.evaluate
                        .for('Identifier')
                        .tap(this.constructor.name, (node) => {
                        var _a, _b;
                        // We will only optimize fonts from first party code.
                        if ((_b = (_a = parser === null || parser === void 0 ? void 0 : parser.state) === null || _a === void 0 ? void 0 : _a.module) === null || _b === void 0 ? void 0 : _b.resource.includes('node_modules')) {
                            return;
                        }
                        let result;
                    ...
                    const jsxNodeHandler = (node) => {
                        ...
                        if (!props.rel ||
                            ...
                            !props.href ||
                            !OPTIMIZED_FONT_PROVIDERS.some(({ url }) => props.href.startsWith(url))) {
                            return false;
                        }
                        this.gatheredStylesheets.push(props.href);
                        const buildInfo = (_b = (_a = parser === null || parser === void 0 ? void 0 : parser.state) === null || _a === void 0 ? void 0 : _a.module) === null || _b === void 0 ? void 0 : _b.buildInfo;
                        if (buildInfo) {
        ...
        compiler.hooks.make.tapAsync(this.constructor.name, (compilation, cb) => {
            compilation.hooks.finishModules.tapAsync(this.constructor.name, async (modules, modulesFinished) => {
                ...
                modules.forEach((module) => {
                    var _a, _b;
                    const fontDependencies = (_b = (_a = module === null || module === void 0 ? void 0 : module.buildInfo) === null || _a === void 0 ? void 0 : _a.valueDependencies) === null || _b === void 0 ? void 0 : _b.get(FONT_MANIFEST);
                    if (fontDependencies) {
