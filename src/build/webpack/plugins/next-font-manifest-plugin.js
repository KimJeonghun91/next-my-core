            ...
            compilation.hooks.processAssets.tap({
                ...
                if (this.appDir) {
                    ...
                    traverseModules(compilation, (mod, _chunk, chunkGroup) => {
                        var _a, _b;
                        if ((_a = mod === null || mod === void 0 ? void 0 : mod.request) === null || _a === void 0 ? void 0 : _a.includes('/next-font-loader/index.js?')) {
                            if (!((_b = mod.buildInfo) === null || _b === void 0 ? void 0 : _b.assets))
                                return;
                        ...
                        return !!((_a = chunkGroup.name) === null || _a === void 0 ? void 0 : _a.startsWith('app/'));
                    });
                }
                ...
                for (const entrypoint of compilation.entrypoints.values()) {
                    ...
                    const fontFiles = entrypoint.chunks
