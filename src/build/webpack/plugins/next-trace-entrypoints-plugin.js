        ...
        await span.traceChild('create-trace-assets').traceAsyncFn(async () => {
            ...
            this.buildTraceContext.chunksTrace = {
                action: {
                    action: 'annotate',
                    input: [...chunksToTrace],
                    contextDirectory: (_b = (_a = this.turbotrace) === null || _a === void 0 ? void 0 : _a.contextDirectory) !== null && _b !== void 0 ? _b : this.tracingRoot,
                    processCwd: (_d = (_c = this.turbotrace) === null || _c === void 0 ? void 0 : _c.processCwd) !== null && _d !== void 0 ? _d : this.rootDir,
                    showAll: (_e = this.turbotrace) === null || _e === void 0 ? void 0 : _e.logAll,
                    logLevel: (_f = this.turbotrace) === null || _f === void 0 ? void 0 : _f.logLevel,
                },
                outputPath,
            ...
            for (const [entrypoint, entryFiles] of entryFilesMap) {
                ...
                if (entrypoint.name.startsWith('app/')) {
                    ...
                    const clientManifestsForPage = entrypoint.name.endsWith('/page') ||
                        entrypoint.name === 'app/not-found' ||
                        entrypoint.name === 'app/_not-found'
                        ? nodePath.join(outputPath, '..', entrypoint.name.replace(/%5F/g, '_') +
                            '_' +
            ...
            await finishModulesSpan
                ...
                finishModulesSpan.traceChild('get-entries').traceFn(() => {
                    compilation.entries.forEach((entry, name) => {
                        const normalizedName = name === null || name === void 0 ? void 0 : name.replace(/\\/g, '/');
                ...
                const readFile = async (path) => {
                    ...
                    const source = (_a = mod === null || mod === void 0 ? void 0 : mod.originalSource) === null || _a === void 0 ? void 0 : _a.call(mod);
                    if (source) {
                ...
                const contextDirectory = (_b = (_a = this.turbotrace) === null || _a === void 0 ? void 0 : _a.contextDirectory) !== null && _b !== void 0 ? _b : this.tracingRoot;
                ...
                this.buildTraceContext.entriesTrace = {
                    action: {
                        ...
                        contextDirectory,
                        processCwd: (_d = (_c = this.turbotrace) === null || _c === void 0 ? void 0 : _c.processCwd) !== null && _d !== void 0 ? _d : this.rootDir,
                        logLevel: (_e = this.turbotrace) === null || _e === void 0 ? void 0 : _e.logLevel,
                        showAll: (_f = this.turbotrace) === null || _f === void 0 ? void 0 : _f.logAll,
                    },
                    appDir: this.rootDir,
                ...
                if (this.turbotrace) {
                    ...
                    if (!(binding === null || binding === void 0 ? void 0 : binding.isWasm) &&
                ...
                await finishModulesSpan
                    ...
                    const parentFilesMap = getFilesMapFromReasons(fileList, reasons, (file) => {
                        ...
                        const isAsset = (_a = reasons
                            .get(nodePath.relative(this.tracingRoot, file))) === null || _a === void 0 ? void 0 : _a.type.includes('asset');
                        return (!isAsset &&
                            Array.isArray(depMod === null || depMod === void 0 ? void 0 : depMod.loaders) &&
                    ...
                    entryPaths.forEach((entry) => {
                        ...
                        (_a = parentFilesMap.get(normalizedEntry)) === null || _a === void 0 ? void 0 : _a.forEach((dep) => {
                        ...
                        if (curExtraEntries) {
                            for (const extraEntry of curExtraEntries.keys()) {
                                ...
                                (_b = parentFilesMap
                                    .get(normalizedExtraEntry)) === null || _b === void 0 ? void 0 : _b.forEach((dep) => {
                                    finalDeps.add(nodePath.join(this.tracingRoot, dep));
                                });
                            }
                        }
    ...
    apply(compiler) {
        compiler.hooks.compilation.tap(PLUGIN_NAME, (compilation) => {
            ...
            traceEntrypointsPluginSpan.traceFn(() => {
                            ...
                            try {
                                ...
                                if (result.includes('node_modules')) {
                                    ...
                                    if (!nodePath.isAbsolute(request) &&
                                        request.includes('/') &&
                                        (resContext === null || resContext === void 0 ? void 0 : resContext.descriptionFileRoot)) {
                                        requestPath = (resContext.descriptionFileRoot +
                                            request.slice(((_a = getPkgName(request)) === null || _a === void 0 ? void 0 : _a.length) || 0) +
                                            nodePath.sep +
                                            'package.json')
                                            .replace(/\\/g, '/')
                                            .replace(/\0/g, '');
                                    ...
                                    let separatorIndex;
                                    while ((separatorIndex = requestPath.lastIndexOf('/')) >
                                        rootSeparatorIndex) {
                ...
                const CJS_RESOLVE_OPTIONS = Object.assign(Object.assign({}, NODE_RESOLVE_OPTIONS), { fullySpecified: undefined, modules: undefined, extensions: undefined });
                const BASE_CJS_RESOLVE_OPTIONS = Object.assign(Object.assign({}, CJS_RESOLVE_OPTIONS), { alias: false });
                const ESM_RESOLVE_OPTIONS = Object.assign(Object.assign({}, NODE_ESM_RESOLVE_OPTIONS), { fullySpecified: undefined, modules: undefined, extensions: undefined });
                const BASE_ESM_RESOLVE_OPTIONS = Object.assign(Object.assign({}, ESM_RESOLVE_OPTIONS), { alias: false });
