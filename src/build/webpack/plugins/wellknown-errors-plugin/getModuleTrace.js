...
export function formatModuleTrace(compiler, moduleTrace) {
    ...
    if (firstExternalModule) {
        const firstExternalPackageName = (_b = (_a = firstExternalModule.resourceResolveData) === null || _a === void 0 ? void 0 : _a.descriptionFileData) === null || _b === void 0 ? void 0 : _b.name;
