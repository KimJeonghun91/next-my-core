...
export class ProfilingPlugin {
    ...
    traceHookPair(spanName, startHook, stopHook, { parentSpan, attrs, onStart, onStop, } = {}) {
        let span;
        startHook.tap({ name: pluginName, stage: -Infinity }, (...params) => {
        ...
        stopHook.tap({ name: pluginName, stage: Infinity }, (...params) => {
    ...
    traceCompilationHooks(compiler) {
        ...
        compiler.hooks.compilation.tap({ name: pluginName, stage: -Infinity }, (compilation) => {
            compilation.hooks.buildModule.tap(pluginName, (module) => {
                ...
                const issuerModule = (_a = compilation === null || compilation === void 0 ? void 0 : compilation.moduleGraph) === null || _a === void 0 ? void 0 : _a.getIssuer(module);
                let span;
            ...
            moduleHooks.loader.tap(pluginName, (loaderContext, module) => {
                var _a;
                const moduleSpan = (_a = moduleSpansByCompilation
                    .get(compilation)) === null || _a === void 0 ? void 0 : _a.get(module);
                loaderContext.currentTraceSpan = moduleSpan;
            });
            compilation.hooks.succeedModule.tap(pluginName, (module) => {
                var _a, _b;
                (_b = (_a = moduleSpansByCompilation === null || moduleSpansByCompilation === void 0 ? void 0 : moduleSpansByCompilation.get(compilation)) === null || _a === void 0 ? void 0 : _a.get(module)) === null || _b === void 0 ? void 0 : _b.stop();
            });
            ...
            compilation.hooks.succeedEntry.tap(pluginName, (entry) => {
                var _a;
                (_a = spans.get(entry)) === null || _a === void 0 ? void 0 : _a.stop();
                spans.delete(entry);
            });
