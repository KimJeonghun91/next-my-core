...
import { BARREL_OPTIMIZATION_PREFIX, CLIENT_REFERENCE_MANIFEST, SYSTEM_ENTRYPOINTS, } from '../../../shared/lib/constants';
...
export class ClientReferenceManifestPlugin {
    ...
    createAsset(assets, compilation, context) {
        ...
        const crossOriginMode = typeof configuredCrossOriginLoading === 'string'
        ...
        (_a = compilation.entrypoints
            .get(CLIENT_STATIC_FILES_RUNTIME_MAIN_APP)) === null || _a === void 0 ? void 0 : _a.getFiles().forEach((file) => {
        ...
        compilation.chunkGroups.forEach((chunkGroup) => {
            ...
            const recordModule = (id, mod) => {
                ...
                let resource = mod.type === 'css/mini-extract'
                ...
                // module ID strategy.
                let ssrNamedModuleId = relative(context, ((_a = mod.resourceResolveData) === null || _a === void 0 ? void 0 : _a.path) || resource);
                ...
                if ((_b = mod.matchResource) === null || _b === void 0 ? void 0 : _b.startsWith(BARREL_OPTIMIZATION_PREFIX)) {
                ...
                function addSSRIdMapping() {
                    ...
                    if (typeof pluginState.serverModuleIds[ssrNamedModuleId] !== 'undefined') {
                        ...
                        moduleIdMapping[id]['*'] = Object.assign(Object.assign({}, manifest.clientModules[exportName]), { 
                            ...
                            chunks: [], id: pluginState.serverModuleIds[ssrNamedModuleId] });
                    }
                    if (typeof pluginState.edgeServerModuleIds[ssrNamedModuleId] !==
                        'undefined') {
                        edgeModuleIdMapping[id] = edgeModuleIdMapping[id] || {};
                        edgeModuleIdMapping[id]['*'] = Object.assign(Object.assign({}, manifest.clientModules[exportName]), { 
                            // During SSR, we don't have external chunks to load on the server
                            // side with our architecture of Webpack / Turbopack. We can keep
                            // this field empty to save some bytes.
                            chunks: [], id: pluginState.edgeServerModuleIds[ssrNamedModuleId] });
                    }
                }
                addClientReference();
                addSSRIdMapping();
                ...
                for (const mod of entryMods) {
                    ...
                    for (const connection of connections) {
                        ...
                        if (modId !== null) {
                            ...
                            if (((_a = connection.module) === null || _a === void 0 ? void 0 : _a.constructor.name) === 'ConcatenatedModule') {
        ...
        for (const pageName of manifestEntryFiles) {
            ...
            if (pagePath === 'app/not-found') {
                ...
                assets['server/app/_not-found_' + CLIENT_REFERENCE_MANIFEST + '.js'] =
                    new sources.RawSource(`globalThis.__RSC_MANIFEST=(globalThis.__RSC_MANIFEST||{});globalThis.__RSC_MANIFEST[${JSON.stringify('/_not-found')}]=${json}`);
            }
        }
