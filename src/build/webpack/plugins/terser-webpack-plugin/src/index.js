...
export class TerserPlugin {
    ...
    async optimize(compiler, compilation, assets, optimizeOptions, cache, { SourceMapSource, RawSource }) {
        ...
        return terserSpan.traceAsyncFn(async () => {
            ...
            const assetsForMinify = await Promise.all(assetsList
                .filter((name) => {
                if (!ModuleFilenameHelpers.matchObject.bind(
                // eslint-disable-next-line no-undefined
                undefined, { test: /\.[cm]?js(\?.*)?$/i })(name)) {
                    return false;
                }
                ...
                if (this.options.swcMinify) {
                    return {
                        minify: async (options) => {
                            const result = await require('../../../../swc').minify(options.input, Object.assign(Object.assign({}, (options.inputSourceMap
                                ? {
                                    sourceMap: {
                    ...
                    return minifySpan.traceAsyncFn(async () => {
                        if (!output) {
                            ...
                            const options = {
                                ...
                                input,
                                inputSourceMap,
                                terserOptions: Object.assign({}, this.options.terserOptions),
                            };
    ...
    apply(compiler) {
        var _a;
        const { SourceMapSource, RawSource } = ((_a = compiler === null || compiler === void 0 ? void 0 : compiler.webpack) === null || _a === void 0 ? void 0 : _a.sources) || sources;
        ...
        compiler.hooks.thisCompilation.tap(pluginName, (compilation) => {
            ...
            }, cache, { SourceMapSource, RawSource }));
