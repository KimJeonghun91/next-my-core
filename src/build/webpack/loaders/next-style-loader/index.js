...
loaderApi.pitch = function loader(request) {
    ...
    return loaderSpan.traceFn(() => {
        ...
        const insert = typeof options.insert === 'undefined'
            ? '"head"'
...
if (module.hot) {
  ...
  module.hot.dispose(function() {
    update();
                    ...
                    : '';
                return `${esModule
                    ? `import api from ${stringifyRequest(this, `!${path.join(__dirname, 'runtime/injectStylesIntoLinkTag.js')}`)};
            import content from ${stringifyRequest(this, `!!${request}`)};`
                    : `var api = require(${stringifyRequest(this, `!${path.join(__dirname, 'runtime/injectStylesIntoLinkTag.js')}`)});
  ...
  module.hot.dispose(function() {
    if (update) {
      update();
                    ...
                    : '';
                return `${esModule
                    ? `import api from ${stringifyRequest(this, `!${path.join(__dirname, 'runtime/injectStylesIntoStyleTag.js')}`)};
            import content from ${stringifyRequest(this, `!!${request}`)};`
                    : `var api = require(${stringifyRequest(this, `!${path.join(__dirname, 'runtime/injectStylesIntoStyleTag.js')}`)});
            var content = require(${stringifyRequest(this, `!!${request}`)});
