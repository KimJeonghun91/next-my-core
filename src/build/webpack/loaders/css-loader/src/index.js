...
function getModulesOptions(rawOptions, loaderContext) {
    ...
    if (typeof rawOptions.modules === 'boolean' ||
        ...
        if (rawOptions.modules) {
            ...
            if (rawOptions.modules.namedExport === true &&
                typeof rawOptions.modules.exportLocalsConvention === 'undefined') {
                modulesOptions.exportLocalsConvention = 'camelCaseOnly';
            }
        }
        modulesOptions = Object.assign(Object.assign({}, modulesOptions), (rawOptions.modules || {}));
    }
