...
export async function getNamedExports(resourcePath, context) {
    var _a;
    ...
    const exportNames = ((_a = mod.dependencies) === null || _a === void 0 ? void 0 : _a.filter((dep) => {
        return ([
...
async function nextMetadataImageLoader(content) {
    ...
    const contentHash = type === 'favicon'
        ? ''
    ...
    if (isDynamicResource) {
        const exportedFieldsExcludingDefault = (await getNamedExports(resourcePath, this)).filter((name) => name !== 'default');
    ...
    const imageData = Object.assign(Object.assign({}, (extension in imageExtMimeTypeMap && {
