...
export const css = curry(async function css(ctx, config) {
    const _a = ctx.sassOptions, { prependData: sassPrependData, additionalData: sassAdditionalData } = _a, sassOptions = __rest(_a, ["prependData", "additionalData"]);
            ...
            ctx.hasAppDir
                ? markRemovable({
                    ...
                    use: [
                        ...
                        ...getCssModuleLoader(Object.assign(Object.assign({}, ctx), { isAppDir: true }), lazyPostCSSInitializer),
                    ],
                })
                : null,
            markRemovable({
                ...
                use: getCssModuleLoader(Object.assign(Object.assign({}, ctx), { isAppDir: false }), lazyPostCSSInitializer),
            }),
        ].filter(nonNullable),
    }), 
            ...
            ctx.hasAppDir
                ? markRemovable({
                    ...
                    use: [
                        ...
                        ...getCssModuleLoader(Object.assign(Object.assign({}, ctx), { isAppDir: true }), lazyPostCSSInitializer, sassPreprocessors),
                    ],
                })
                : null,
            markRemovable({
                ...
                test: regexSassModules,
                issuerLayer: PAGES_LAYER_RULE,
                use: getCssModuleLoader(Object.assign(Object.assign({}, ctx), { isAppDir: false }), lazyPostCSSInitializer, sassPreprocessors),
            }),
        ].filter(nonNullable),
    }), 
        ...
        fns.push(loader({
            oneOf: [
                    ...
                    ? [
                        markRemovable({
                            ...
                            use: [
                                ...
                                ...getGlobalCssLoader(Object.assign(Object.assign({}, ctx), { isAppDir: true }), lazyPostCSSInitializer),
                            ],
                        }),
                        markRemovable({
                            sideEffects: true,
                            ...
                            use: [
                                ...
                                ...getGlobalCssLoader(Object.assign(Object.assign({}, ctx), { isAppDir: true }), lazyPostCSSInitializer, sassPreprocessors),
                            ],
                        }),
                    ]
                    : []),
                markRemovable({
                    ...
                    issuerLayer: PAGES_LAYER_RULE,
                    use: getGlobalCssLoader(Object.assign(Object.assign({}, ctx), { isAppDir: false }), lazyPostCSSInitializer),
                }),
                markRemovable({
                    sideEffects: true,
                    test: regexSassGlobal,
                    ...
                    issuer: allowedPagesGlobalCSSIssuer,
                    issuerLayer: PAGES_LAYER_RULE,
                    use: getGlobalCssLoader(Object.assign(Object.assign({}, ctx), { isAppDir: false }), lazyPostCSSInitializer, sassPreprocessors),
                }),
            ].filter(nonNullable),
        }));
