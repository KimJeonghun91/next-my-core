...
const pageMod = Object.assign(Object.assign({}, userlandPage), { routeModule: new RouteModule(Object.assign(Object.assign({}, pageRouteModuleOptions), { components: {
            App: appMod.default,
            Document,
        }, userland: userlandPage })) });
const errorMod = Object.assign(Object.assign({}, userlandErrorPage), { routeModule: new RouteModule(Object.assign(Object.assign({}, errorRouteModuleOptions), { components: {
            App: appMod.default,
            Document,
        }, userland: userlandErrorPage })) });
// FIXME: this needs to be made compatible with the template
const error500Mod = userland500Page
    ? Object.assign(Object.assign({}, userland500Page), { routeModule: new RouteModule(Object.assign(Object.assign({}, user500RouteModuleOptions), { components: {
                App: appMod.default,
                Document,
            }, userland: userland500Page })) }) : null;
