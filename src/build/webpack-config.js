...
const devtoolRevertWarning = execOnce((devtool) => {
    console.warn(yellow(bold('Warning: ')) +
...
export function attachReactRefresh(webpackConfig, targetLoader) {
    ...
    (_b = (_a = webpackConfig.module) === null || _a === void 0 ? void 0 : _a.rules) === null || _b === void 0 ? void 0 : _b.forEach((rule) => {
...
function getOpenTelemetryVersion() {
    var _a, _b;
    try {
        return (_b = (_a = require('@opentelemetry/api/package.json')) === null || _a === void 0 ? void 0 : _a.version) !== null && _b !== void 0 ? _b : null;
    }
    catch (_c) {
        return null;
    }
...
export default async function getBaseWebpackConfig(dir, { buildId, config, compilerType, dev = false, entrypoints, isDevFallback = false, pagesDir, reactProductionProfiling = false, rewrites, originalRewrites, originalRedirects, runWebpackSpan, appDir, middlewareMatchers, noMangling = false, jsConfig, resolvedBaseUrl, supportedBrowsers, clientRouterFilters, previewModeId, fetchCacheKeyPrefix, allowedRevalidateHeaderKeys, }) {
    ...
    const hasRewrites = rewrites.beforeFiles.length > 0 ||
    ...
    if (useSWCLoader) {
        ...
        const binaryTarget = (_c = (_b = (_a = require('./swc')) === null || _a === void 0 ? void 0 : _a.getBinaryMetadata) === null || _b === void 0 ? void 0 : _b.call(_a)) === null || _c === void 0 ? void 0 : _c.target;
        SWCBinaryTarget = binaryTarget
            ? [`swc/target/${binaryTarget}`, true]
            : undefined;
    }
    ...
    const getSwcLoader = (extraOptions) => {
        var _a, _b, _c, _d;
        if (((_a = config === null || config === void 0 ? void 0 : config.experimental) === null || _a === void 0 ? void 0 : _a.swcTraceProfiling) &&
            ...
            (_c = (_b = require('./swc')) === null || _b === void 0 ? void 0 : _b.initCustomTraceSubscriber) === null || _c === void 0 ? void 0 : _c.call(_b, path.join(distDir, `swc-trace-profile-${Date.now()}.json`));
        }
        return {
            loader: 'next-swc-loader',
            options: Object.assign({ isServer: isNodeOrEdgeCompilation, rootDir: dir, pagesDir,
                appDir, hasReactRefresh: dev && isClient, nextConfig: config, jsConfig,
                supportedBrowsers, swcCacheDir: path.join(dir, (_d = config === null || config === void 0 ? void 0 : config.distDir) !== null && _d !== void 0 ? _d : '.next', 'cache', 'swc'), transpilePackages: config.transpilePackages }, extraOptions),
        };
    };
    ...
    const reactRefreshLoaders = dev && isClient ? [require.resolve(reactRefreshLoaderName)] : [];
    ...
    // be performed.
    const apiRoutesLayerLoaders = hasAppDir && useSWCLoader
        ? getSwcLoader({
            serverComponents: false,
        ...
        ? (Object.assign(Object.assign(Object.assign({ 
            ...
            ? {
                ...
                [CLIENT_STATIC_FILES_RUNTIME_AMP]: `./` +
                    path
                        .relative(dir, path.join(NEXT_PROJECT_ROOT_DIST_CLIENT, 'dev', 'amp-dev'))
                        .replace(/\\/g, '/'),
            }
            : {})), { [CLIENT_STATIC_FILES_RUNTIME_MAIN]: `./` +
                path
                    .relative(dir, path.join(NEXT_PROJECT_ROOT_DIST_CLIENT, dev ? `next-dev.js` : 'next.js'))
                    .replace(/\\/g, '/') }), (hasAppDir
            ? {
                [CLIENT_STATIC_FILES_RUNTIME_MAIN_APP]: dev
                    ? [
                        ...
                        `./` +
                            path
                                .relative(dir, path.join(NEXT_PROJECT_ROOT_DIST_CLIENT, 'app-next-dev.js'))
                                .replace(/\\/g, '/'),
                    ]
                    : [
                        `./` +
                            path
                                .relative(dir, path.join(NEXT_PROJECT_ROOT_DIST_CLIENT, 'app-next.js'))
                                .replace(/\\/g, '/'),
                    ],
            }
            : {})))
        : undefined;
    const resolveConfig = Object.assign(Object.assign(Object.assign(Object.assign({ 
        // Disable .mjs for node_modules bundling
        extensions: ['.js', '.mjs', '.tsx', '.ts', '.jsx', '.json', '.wasm'], extensionAlias: config.experimental.extensionAlias, modules: [
            'node_modules',
        ...
        mainFields: getMainField(compilerType, false) }), (isEdgeServer && {
    ...
    const terserOptions = {
        ...
        mangle: Object.assign({ safari10: true }, (process.env.__NEXT_MANGLING_DEBUG || noMangling
            ? {
                toplevel: true,
                module: true,
            ...
            : {})),
        output: Object.assign({ ecma: 5, safari10: true, comments: false, 
            // Fixes usage of Emoji and certain Regex
            ascii_only: true }, (process.env.__NEXT_MANGLING_DEBUG || noMangling
            ? {
                beautify: true,
            }
            : {})),
    ...
    const addPackagePath = (packageName, relativeToPath) => {
        try {
            ...
            if (topLevelFrameworkPaths.includes(directory))
                return;
    ...
    if (config.experimental.serverComponentsExternalPackages &&
        ...
        const externalPackageConflicts = config.transpilePackages.filter((pkg) => { var _a; return (_a = config.experimental.serverComponentsExternalPackages) === null || _a === void 0 ? void 0 : _a.includes(pkg); });
    ...
    const optOutBundlingPackages = EXTERNAL_PACKAGES.concat(...(config.experimental.serverComponentsExternalPackages || [])).filter((pkg) => { var _a; return !((_a = config.transpilePackages) === null || _a === void 0 ? void 0 : _a.includes(pkg)); });
    // For resolved request, such as `absolute path/package name/foo/bar.js`
    const optOutBundlingPackageRegex = new RegExp(`[/\\\\]node_modules[/\\\\](${optOutBundlingPackages
        .map((p) => p.replace(/\//g, '[/\\\\]'))
        .join('|')})[/\\\\]`);
    const transpilePackagesRegex = new RegExp(`[/\\\\]node_modules[/\\\\](${(_d = config.transpilePackages) === null || _d === void 0 ? void 0 : _d.map((p) => p.replace(/\//g, '[/\\\\]')).join('|')})[/\\\\]`);
    ...
    const codeCondition = Object.assign(Object.assign({ test: { or: [/\.(tsx|ts|js|cjs|mjs|jsx)$/, /__barrel_optimize__/] } }, (shouldIncludeExternalDirs
        ? // Allowing importing TS/TSX files from outside of the root dir.
            {}
        : { include: [dir, ...babelIncludeRegexes] })), { exclude: (excludePath) => {
    ...
    let webpackConfig = Object.assign(Object.assign({ parallelism: Number(process.env.NEXT_WEBPACK_PARALLELISM) || undefined }, (isNodeServer ? { externalsPresets: { node: true } } : {})), { 
        // @ts-ignore
        externals: isClient || isEdgeServer
                    ...
                    return (resolveContext, requestToResolve) => new Promise((resolve, reject) => {
                        resolveFunction(resolveContext, requestToResolve, (err, result, resolveData) => {
                            ...
                            const isEsm = /\.js$/i.test(result)
                                ? ((_a = resolveData === null || resolveData === void 0 ? void 0 : resolveData.descriptionFileData) === null || _a === void 0 ? void 0 : _a.type) ===
                                    'module'
                                : /\.mjs$/i.test(result);
            ...
            minimizer: [
                ...
                (compiler) => {
                    ...
                    new TerserPlugin({
                        ...
                        terserOptions: Object.assign(Object.assign({}, terserOptions), { compress: Object.assign({}, terserOptions.compress), mangle: Object.assign({}, terserOptions.mangle) }),
                    }).apply(compiler);
                },
                // Minify CSS
                (compiler) => {
        ...
        entry: async () => {
            return Object.assign(Object.assign({}, (clientEntries ? clientEntries : {})), entrypoints);
        }, watchOptions, output: {
            ...
            chunkFilename: isNodeOrEdgeCompilation
                ? '[name].js'
                : `static/chunks/${isDevFallback ? 'fallback/' : ''}${dev ? '[name]' : '[name].[contenthash]'}.js`,
            strictModuleExceptionHandling: true,
            crossOriginLoading: crossOrigin,
            webassemblyModuleFilename: 'static/wasm/[modulehash].wasm',
            hashFunction: 'xxhash64',
            hashDigestLength: 16,
        }, performance: false, resolve: resolveConfig, resolveLoader: {
            ...
            rules: [
                ...
                ...(hasAppDir
                    ? [
                        ...
                        },
                        {
                            ...
                            resolve: {
                                alias: Object.assign(Object.assign({}, createNextApiEsmAliases()), createAppRouterApiAliases()),
                            },
                        },
                    ]
                    : []),
                ...
                {
                    oneOf: [
                        Object.assign(Object.assign({}, codeCondition), { issuerLayer: WEBPACK_LAYERS.api, parser: {
                        ...
                        ...(hasAppDir
                            ...
                            : []),
                        Object.assign(Object.assign({}, codeCondition), { use: [...reactRefreshLoaders, defaultLoaders.babel] }),
                    ],
                },
                ...
                },
                {
                    ...
                    use: ({ resourceQuery }) => {
                        var _a, _b;
                        const names = (((_a = resourceQuery.match(/\?names=([^&]+)/)) === null || _a === void 0 ? void 0 : _a[1]) || '').split(',');
                        return [
                            {
                                loader: 'next-barrel-loader',
                                options: {
                                    names,
                                    swcCacheDir: path.join(dir, (_b = config === null || config === void 0 ? void 0 : config.distDir) !== null && _b !== void 0 ? _b : '.next', 'cache', 'swc'),
                                },
            ...
            isNodeServer &&
                new webpack.NormalModuleReplacementPlugin(/\.\/(.+)\.shared-runtime$/, function (resource) {
            ...
            (isClient || isEdgeServer) &&
                new webpack.ProvidePlugin(Object.assign({ 
                    ...
                    Buffer: [require.resolve('buffer'), 'Buffer'] }, (isClient && { process: [require.resolve('process')] }))),
            getDefineEnvPlugin({
                isTurbopack: false,
            ...
            isEdgeServer &&
                new MiddlewarePlugin({
                    dev,
                    sriEnabled: !dev && !!((_e = config.experimental.sri) === null || _e === void 0 ? void 0 : _e.algorithm),
                }),
            isClient &&
            ...
            !dev &&
                isClient &&
                !!((_f = config.experimental.sri) === null || _f === void 0 ? void 0 : _f.algorithm) &&
            ...
            !dev &&
                isClient &&
                new (require('./webpack/plugins/telemetry-plugin').TelemetryPlugin)(new Map([
                    ['swcLoader', useSWCLoader],
                    ['swcMinify', config.swcMinify],
                    ['swcRelay', !!((_g = config.compiler) === null || _g === void 0 ? void 0 : _g.relay)],
                    ['swcStyledComponents', !!((_h = config.compiler) === null || _h === void 0 ? void 0 : _h.styledComponents)],
                    [
                        'swcReactRemoveProperties',
                        !!((_j = config.compiler) === null || _j === void 0 ? void 0 : _j.reactRemoveProperties),
                    ],
                    [
                        'swcExperimentalDecorators',
                        !!((_k = jsConfig === null || jsConfig === void 0 ? void 0 : jsConfig.compilerOptions) === null || _k === void 0 ? void 0 : _k.experimentalDecorators),
                    ],
                    ['swcRemoveConsole', !!((_l = config.compiler) === null || _l === void 0 ? void 0 : _l.removeConsole)],
                    ['swcImportSource', !!((_m = jsConfig === null || jsConfig === void 0 ? void 0 : jsConfig.compilerOptions) === null || _m === void 0 ? void 0 : _m.jsxImportSource)],
                    ['swcEmotion', !!((_o = config.compiler) === null || _o === void 0 ? void 0 : _o.emotion)],
                    ['turbotrace', !!config.experimental.turbotrace],
    ...
    if (resolvedBaseUrl && !resolvedBaseUrl.isImplicit) {
        (_q = (_p = webpackConfig.resolve) === null || _p === void 0 ? void 0 : _p.modules) === null || _q === void 0 ? void 0 : _q.push(resolvedBaseUrl.baseUrl);
    }
    // always add JsConfigPathsPlugin to allow hot-reloading
    // if the config is added/removed
    (_s = (_r = webpackConfig.resolve) === null || _r === void 0 ? void 0 : _r.plugins) === null || _s === void 0 ? void 0 : _s.unshift(new JsConfigPathsPlugin(((_t = jsConfig === null || jsConfig === void 0 ? void 0 : jsConfig.compilerOptions) === null || _t === void 0 ? void 0 : _t.paths) || {}, resolvedBaseUrl));
    const webpack5Config = webpackConfig;
    if (isEdgeServer) {
        (_v = (_u = webpack5Config.module) === null || _u === void 0 ? void 0 : _u.rules) === null || _v === void 0 ? void 0 : _v.unshift({
            test: /\.wasm$/,
            loader: 'next-middleware-wasm-loader',
            type: 'javascript/auto',
            resourceQuery: /module/i,
        });
        (_x = (_w = webpack5Config.module) === null || _w === void 0 ? void 0 : _w.rules) === null || _x === void 0 ? void 0 : _x.unshift({
            dependency: 'url',
            loader: 'next-middleware-asset-loader',
            type: 'javascript/auto',
            layer: WEBPACK_LAYERS.edgeAsset,
        });
        (_z = (_y = webpack5Config.module) === null || _y === void 0 ? void 0 : _y.rules) === null || _z === void 0 ? void 0 : _z.unshift({
    ...
    webpack5Config.experiments = {
        ...
        buildHttp: Array.isArray(config.experimental.urlImports)
            ...
            : config.experimental.urlImports
                ? Object.assign({ cacheLocation: path.join(dir, 'next.lock/data'), lockfileLocation: path.join(dir, 'next.lock/lock.json') }, config.experimental.urlImports) : undefined,
    };
    ...
    const configVars = JSON.stringify({
        ...
        swcMinify: config.swcMinify,
        swcLoader: useSWCLoader,
        removeConsole: (_0 = config.compiler) === null || _0 === void 0 ? void 0 : _0.removeConsole,
        reactRemoveProperties: (_1 = config.compiler) === null || _1 === void 0 ? void 0 : _1.reactRemoveProperties,
        styledComponents: (_2 = config.compiler) === null || _2 === void 0 ? void 0 : _2.styledComponents,
        relay: (_3 = config.compiler) === null || _3 === void 0 ? void 0 : _3.relay,
        emotion: (_4 = config.compiler) === null || _4 === void 0 ? void 0 : _4.emotion,
        modularizeImports: config.modularizeImports,
    ...
    if (typeof config.webpack === 'function') {
        webpackConfig = config.webpack(webpackConfig, Object.assign({ dir,
            dev, isServer: isNodeOrEdgeCompilation, buildId,
            config,
            defaultLoaders, totalPages: Object.keys(entrypoints).length, webpack }, (isNodeOrEdgeCompilation
            ? {
        ...
        if (((_5 = webpack5Config.experiments) === null || _5 === void 0 ? void 0 : _5.lazyCompilation) === true) {
            webpack5Config.experiments.lazyCompilation = {
                entries: false,
            };
        }
        else if (typeof ((_6 = webpack5Config.experiments) === null || _6 === void 0 ? void 0 : _6.lazyCompilation) === 'object' &&
    ...
    if (!config.images.disableStaticImages) {
        const rules = ((_7 = webpackConfig.module) === null || _7 === void 0 ? void 0 : _7.rules) || [];
        const hasCustomSvg = rules.some((rule) => rule &&
            typeof rule === 'object' &&
    ...
    if (config.experimental.craCompat &&
        ((_8 = webpackConfig.module) === null || _8 === void 0 ? void 0 : _8.rules) &&
    ...
    const hasUserCssConfig = (_11 = (_10 = (_9 = webpackConfig.module) === null || _9 === void 0 ? void 0 : _9.rules) === null || _10 === void 0 ? void 0 : _10.some((rule) => canMatchCss(rule.test) || canMatchCss(rule.include))) !== null && _11 !== void 0 ? _11 : false;
    if (hasUserCssConfig) {
        // only show warning for one build
        if (isNodeOrEdgeCompilation) {
            console.warn(yellow(bold('Warning: ')) +
                bold('Built-in CSS support is being disabled due to custom CSS configuration being detected.\n') +
                'See here for more info: https://nextjs.org/docs/messages/built-in-css-disabled\n');
        }
        if ((_13 = (_12 = webpackConfig.module) === null || _12 === void 0 ? void 0 : _12.rules) === null || _13 === void 0 ? void 0 : _13.length) {
        ...
        if ((_14 = webpackConfig.plugins) === null || _14 === void 0 ? void 0 : _14.length) {
            // Disable CSS Extraction Plugin
            webpackConfig.plugins = webpackConfig.plugins.filter((p) => p.__next_css_remove !== true);
        }
        if ((_16 = (_15 = webpackConfig.optimization) === null || _15 === void 0 ? void 0 : _15.minimizer) === null || _16 === void 0 ? void 0 : _16.length) {
            // Disable CSS Minifier
            webpackConfig.optimization.minimizer =
                webpackConfig.optimization.minimizer.filter((e) => e.__next_css_remove !== true);
        }
    }
