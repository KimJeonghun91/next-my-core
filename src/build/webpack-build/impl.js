...
export async function webpackBuildImpl(compilerName) {
    ...
    const configs = await runWebpackSpan
        ...
        return Promise.all([
            getBaseWebpackConfig(dir, Object.assign(Object.assign(Object.assign({}, commonWebpackOptions), { middlewareMatchers: entrypoints.middlewareMatchers, runWebpackSpan, compilerType: COMPILER_NAMES.client, entrypoints: entrypoints.client }), info)),
            getBaseWebpackConfig(dir, Object.assign(Object.assign(Object.assign({}, commonWebpackOptions), { runWebpackSpan, middlewareMatchers: entrypoints.middlewareMatchers, compilerType: COMPILER_NAMES.server, entrypoints: entrypoints.server }), info)),
            getBaseWebpackConfig(dir, Object.assign(Object.assign(Object.assign({}, commonWebpackOptions), { runWebpackSpan, middlewareMatchers: entrypoints.middlewareMatchers, compilerType: COMPILER_NAMES.edgeServer, entrypoints: entrypoints.edgeServer }), info)),
        ]);
    });
    const clientConfig = configs[0];
    const serverConfig = configs[1];
    const edgeConfig = configs[2];
    if (clientConfig.optimization &&
    ...
    await runWebpackSpan.traceAsyncFn(async () => {
        ...
        if (!(serverResult === null || serverResult === void 0 ? void 0 : serverResult.errors.length) && !(edgeServerResult === null || edgeServerResult === void 0 ? void 0 : edgeServerResult.errors.length)) {
        ...
        result = {
            warnings: []
                .concat(clientResult === null || clientResult === void 0 ? void 0 : clientResult.warnings, serverResult === null || serverResult === void 0 ? void 0 : serverResult.warnings, edgeServerResult === null || edgeServerResult === void 0 ? void 0 : edgeServerResult.warnings)
                .filter(nonNullable),
            errors: []
                .concat(clientResult === null || clientResult === void 0 ? void 0 : clientResult.errors, serverResult === null || serverResult === void 0 ? void 0 : serverResult.errors, edgeServerResult === null || edgeServerResult === void 0 ? void 0 : edgeServerResult.errors)
                .filter(nonNullable),
            stats: [
    ...
    const telemetryPlugin = (_a = clientConfig.plugins) === null || _a === void 0 ? void 0 : _a.find(isTelemetryPlugin);
    const traceEntryPointsPlugin = (_b = serverConfig.plugins) === null || _b === void 0 ? void 0 : _b.find(isTraceEntryPointsPlugin);
    ...
    if (result.errors.length > 0) {
        ...
        return {
            ...
            buildTraceContext: traceEntryPointsPlugin === null || traceEntryPointsPlugin === void 0 ? void 0 : traceEntryPointsPlugin.buildTraceContext,
            pluginState: getPluginState(),
            telemetryState: {
                usages: (telemetryPlugin === null || telemetryPlugin === void 0 ? void 0 : telemetryPlugin.usages()) || [],
                packagesUsedInServerSideProps: (telemetryPlugin === null || telemetryPlugin === void 0 ? void 0 : telemetryPlugin.packagesUsedInServerSideProps()) || [],
            },
        };
    }
}
...
export async function workerMain(workerData) {
    ...
    const { entriesTrace, chunksTrace } = (_a = result.buildTraceContext) !== null && _a !== void 0 ? _a : {};
    if (entriesTrace) {
    ...
    if (chunksTrace === null || chunksTrace === void 0 ? void 0 : chunksTrace.entryNameFilesMap) {
    ...
    return Object.assign(Object.assign({}, result), { debugTraceEvents: getTraceEvents() });
}
