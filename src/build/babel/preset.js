...
export default (api, options = {}) => {
    ...
    const isDevelopment = isCallerDevelopment === true ||
    ...
    const isBabelLoader = api.caller((caller) => !!caller &&
    ...
    return {
        ...
        presets: [
            ...
            [
                ...
                Object.assign(Object.assign({ 
                    ...
                    development: isDevelopment || isTest }, (useJsxRuntime ? { runtime: 'automatic' } : { pragma: '__jsx' })), options['preset-react']),
            ],
            [
        ...
        plugins: [
            ...
            !isServer && [
                ...
                Object.assign({ corejs: false, helpers: true, regenerator: true, useESModules: supportsESM && presetEnvConfig.modules !== 'commonjs', absoluteRuntime: isBabelLoader
