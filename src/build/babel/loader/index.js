...
const nextBabelLoaderOuter = function nextBabelLoaderOuter(inputSource, inputSourceMap) {
    ...
    loaderSpan
        .traceAsyncFn(() => nextBabelLoader.call(this, loaderSpan, inputSource, inputSourceMap))
        .then(([transformedSource, outputSourceMap]) => callback === null || callback === void 0 ? void 0 : callback(null, transformedSource, outputSourceMap || inputSourceMap), (err) => {
