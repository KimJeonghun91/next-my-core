...
export function createWebpackAliases({ distDir, isClient, isEdgeServer, isNodeServer, dev, config, pagesDir, appDir, dir, reactProductionProfiling, hasRewrites, }) {
    ...
    return Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({ '@vercel/og$': 'next/dist/server/og/image-response' }, (isEdgeServer
        ? Object.assign({ 'next/dist/api': 'next/dist/esm/api', 'next/dist/build': 'next/dist/esm/build', 'next/dist/client': 'next/dist/esm/client', 'next/dist/shared': 'next/dist/esm/shared', 'next/dist/pages': 'next/dist/esm/pages', 'next/dist/lib': 'next/dist/esm/lib', 'next/dist/server': 'next/dist/esm/server' }, createNextApiEsmAliases()) : undefined)), (!hasExternalOtelApiPackage() && {
        '@opentelemetry/api': 'next/dist/compiled/@opentelemetry/api',
    })), (config.images.loaderFile
        ? Object.assign({ 'next/dist/shared/lib/image-loader': config.images.loaderFile }, (isEdgeServer && {
            'next/dist/esm/shared/lib/image-loader': config.images.loaderFile,
        })) : undefined)), { next: NEXT_PROJECT_ROOT, 'styled-jsx/style$': defaultOverrides['styled-jsx/style'], 'styled-jsx$': defaultOverrides['styled-jsx'] }), customAppAliases), customDocumentAliases), (pagesDir ? { [PAGES_DIR_ALIAS]: pagesDir } : {})), (appDir ? { [APP_DIR_ALIAS]: appDir } : {})), { [ROOT_DIR_ALIAS]: dir, [DOT_NEXT_ALIAS]: distDir }), (isClient || isEdgeServer ? getOptimizedModuleAliases() : {})), (reactProductionProfiling ? getReactProfilingInProduction() : {})), (isNodeServer
        ? getBarrelOptimizationAliases(config.experimental.optimizePackageImports || [])
        : {})), { [RSC_ACTION_VALIDATE_ALIAS]: 'next/dist/build/webpack/loaders/next-flight-loader/action-validate', [RSC_ACTION_CLIENT_WRAPPER_ALIAS]: 'next/dist/build/webpack/loaders/next-flight-loader/action-client-wrapper', [RSC_ACTION_PROXY_ALIAS]: 'next/dist/build/webpack/loaders/next-flight-loader/server-reference', [RSC_ACTION_ENCRYPTION_ALIAS]: 'next/dist/server/app-render/action-encryption' }), (isClient || isEdgeServer
        ? {
        ...
        : {})), { '@swc/helpers/_': path.join(path.dirname(require.resolve('@swc/helpers/package.json')), '_'), setimmediate: 'next/dist/compiled/setimmediate' });
}
