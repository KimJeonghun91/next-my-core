...
buildStore.subscribe((state) => {
    ...
    let partialState = {
        ...
        loading: false,
        typeChecking: false,
        totalModulesCount: (clientWasLoading ? client.totalModulesCount : 0) +
            (serverWasLoading ? server.totalModulesCount : 0) +
            (edgeServerWasLoading ? (edgeServer === null || edgeServer === void 0 ? void 0 : edgeServer.totalModulesCount) || 0 : 0),
        hasEdgeServer: !!edgeServer,
    };
    if (client.errors && clientWasLoading) {
        // Show only client errors
        consoleStore.setState(Object.assign(Object.assign({}, partialState), { errors: client.errors, warnings: null }), true);
    }
    else if (server.errors && serverWasLoading) {
        consoleStore.setState(Object.assign(Object.assign({}, partialState), { errors: server.errors, warnings: null }), true);
    }
    else if (edgeServer.errors && edgeServerWasLoading) {
        consoleStore.setState(Object.assign(Object.assign({}, partialState), { errors: edgeServer.errors, warnings: null }), true);
    }
    else {
        ...
        consoleStore.setState(Object.assign(Object.assign({}, partialState), { errors: null, warnings: warnings.length === 0 ? null : warnings }), true);
    }
});
export function ampValidation(page, errors, warnings) {
    ...
    const newAmp = Object.assign(Object.assign({}, amp), { [page]: { errors, warnings } });
    buildStore.setState({
