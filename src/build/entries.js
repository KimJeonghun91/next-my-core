...
export function createPagesMapping({ isDev, pageExtensions, pagePaths, pagesType, pagesDir, }) {
    ...
    const pages = pagePaths.reduce((result, pagePath) => {
        ...
        const normalizedPath = normalizePathSep(join(pagesType === 'pages'
            ? PAGES_DIR_ALIAS
            : pagesType === 'app'
                ? APP_DIR_ALIAS
                : ROOT_DIR_ALIAS, pagePath));
    ...
    switch (pagesType) {
        ...
        case PAGE_TYPES.APP: {
            ...
            return Object.assign(Object.assign({}, (hasAppPages && {
        ...
        case PAGE_TYPES.PAGES: {
            ...
            return Object.assign({ '/_app': `${root}/_app`, '/_error': `${root}/_error`, '/_document': `${root}/_document` }, pages);
        }
        default: {
            return {};
        }
...
export function getEdgeServerEntry(opts) {
    ...
    if (isMiddlewareFile(opts.page)) {
        const loaderParams = {
            ...
            matchers: ((_a = opts.middleware) === null || _a === void 0 ? void 0 : _a.matchers)
    ...
    const loaderParams = {
        ...
        appDirLoader: Buffer.from(opts.appDirLoader || '').toString('base64'),
        sriEnabled: !opts.isDev && !!((_b = opts.config.experimental.sri) === null || _b === void 0 ? void 0 : _b.algorithm),
...
export function runDependingOnPageType(params) {
    if (params.pageType === PAGE_TYPES.ROOT &&
...
export async function createEntrypoints(params) {
    ...
    const getEntryHandler = (mappings, pagesType) => async (page) => {
        ...
        const serverBundlePath = pagesType === PAGE_TYPES.PAGES
        ...
        if (isMiddlewareFile(page)) {
            middlewareMatchers = (_b = (_a = staticInfo.middleware) === null || _a === void 0 ? void 0 : _a.matchers) !== null && _b !== void 0 ? _b : [
        ...
        runDependingOnPageType({
            ...
            onServer: () => {
                ...
                else if (isInstrumentationHookFile(page) &&
            ...
            onEdgeServer: () => {
                ...
                const normalizedServerBundlePath = isInstrumentationHookFile(page) && pagesType === PAGE_TYPES.ROOT
                    ? serverBundlePath.replace('src/', '')
                    : serverBundlePath;
                edgeServer[normalizedServerBundlePath] = getEdgeServerEntry(Object.assign(Object.assign({}, params), { rootDir, absolutePagePath: absolutePagePath, bundlePath: clientBundlePath, isDev: false, isServerComponent,
                    page, middleware: staticInfo === null || staticInfo === void 0 ? void 0 : staticInfo.middleware, pagesType,
                    appDirLoader, preferredRegion: staticInfo.preferredRegion, middlewareConfig: staticInfo.middleware }));
            },
        });
    };
    const promises = [];
...
export function finalizeEntrypoint({ name, compilerType, value, isServerComponent, hasAppDir, }) {
    ...
    switch (compilerType) {
        case COMPILER_NAMES.server: {
            return Object.assign({ publicPath: isApi ? '' : undefined, runtime: isApi ? 'webpack-api-runtime' : 'webpack-runtime', layer: isApi
                    ? WEBPACK_LAYERS.api
                    : isServerComponent
        ...
        case COMPILER_NAMES.edgeServer: {
            return Object.assign({ layer: isMiddlewareFilename(name) || isApi
                    ? WEBPACK_LAYERS.middleware
                    : undefined, library: { name: ['_ENTRIES', `middleware_[name]`], type: 'assign' }, runtime: EDGE_RUNTIME_WEBPACK, asyncChunks: false }, entry);
        }
        case COMPILER_NAMES.client: {
            const isAppLayer = hasAppDir &&
            ...
            name !== CLIENT_STATIC_FILES_RUNTIME_POLYFILLS &&
                ...
                if (isAppLayer) {
                    return Object.assign({ dependOn: CLIENT_STATIC_FILES_RUNTIME_MAIN_APP, layer: WEBPACK_LAYERS.appPagesBrowser }, entry);
                }
                return Object.assign({ dependOn: name.startsWith('pages/') && name !== 'pages/_app'
                        ? 'pages/_app'
                        : CLIENT_STATIC_FILES_RUNTIME_MAIN }, entry);
            }
            if (isAppLayer) {
                return Object.assign({ layer: WEBPACK_LAYERS.appPagesBrowser }, entry);
            }
            return entry;
        }
        default: {
