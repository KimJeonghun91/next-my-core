...
const eslintOptions = (args, defaultCacheLocation) => {
    ...
    return ({
        ...
        extensions: (_a = args['--ext']) !== null && _a !== void 0 ? _a : [
            '.js',
            '.mjs',
            '.cjs',
            '.jsx',
        ...
        rulePaths: (_b = args['--rulesdir']) !== null && _b !== void 0 ? _b : [],
        fix: (_c = args['--fix']) !== null && _c !== void 0 ? _c : false,
        fixTypes: (_d = args['--fix-type']) !== null && _d !== void 0 ? _d : null,
...
const nextLint = async (args) => {
    ...
    const files = (_a = args['--file']) !== null && _a !== void 0 ? _a : [];
    const dirs = (_b = args['--dir']) !== null && _b !== void 0 ? _b : (_c = nextConfig.eslint) === null || _c === void 0 ? void 0 : _c.dirs;
    const filesToLint = [...(dirs !== null && dirs !== void 0 ? dirs : []), ...files];
    const pathsToLint = (filesToLint.length ? filesToLint : ESLINT_DEFAULT_DIRS).reduce((res, d) => {
    ...
    const maxWarnings = (_d = args['--max-warnings']) !== null && _d !== void 0 ? _d : -1;
    ...
    runLintCheck(baseDir, pathsToLint, {
        ...
        if (typeof lintResults !== 'string' && (lintResults === null || lintResults === void 0 ? void 0 : lintResults.eventInfo)) {
            ...
            telemetry.record(eventLintCheckCompleted(Object.assign(Object.assign({}, lintResults.eventInfo), { buildLint: false })));
            await telemetry.flush();
        }
        if (typeof lintResults !== 'string' &&
            (lintResults === null || lintResults === void 0 ? void 0 : lintResults.isError) &&
            lintOutput) {
