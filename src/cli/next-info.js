...
async function getNextConfig() {
    ...
    return {
        output: (_a = config.output) !== null && _a !== void 0 ? _a : 'N/A',
        experimental: {
            useWasmBinary: (_b = config.experimental) === null || _b === void 0 ? void 0 : _b.useWasmBinary,
        },
    };
}
/**
...
`);
    try {
        ...
        if (installedRelease !== newestRelease) {
            console.warn(`${yellow(bold('warn'))}  - Latest canary version not detected, detected: "${installedRelease}", newest: "${newestRelease}".
        Please try the latest canary version (\`npm install next@canary\`) to confirm the issue still exists before creating a new issue.
        Read more - https://nextjs.org/docs/messages/opening-an-issue`);
        }
    }
    catch (e) {
        console.warn(`${yellow(bold('warn'))}  - Failed to fetch latest canary version. (Reason: ${e.message}.)
...
async function runSharedDependencyCheck(tools, skipMessage) {
    ...
    const triples = (_b = (_a = getSupportedArchTriples()[currentPlatform]) === null || _a === void 0 ? void 0 : _a[os.arch()]) !== null && _b !== void 0 ? _b : [];
...
`;
        ...
        },
        {
            ...
            scripts: {
                default: async () => {
                    ...
                    header === null || header === void 0 ? true : delete header.cwd;
                    header === null || header === void 0 ? true : delete header.commandLine;
                    header === null || header === void 0 ? true : delete header.host;
                    header === null || header === void 0 ? true : delete header.cpus;
                    header === null || header === void 0 ? true : delete header.networkInterfaces;
                    const reportSummary = {
                        header,
                        javascriptHeap,
                        sharedObjects,
            ...
            scripts: {
                default: async () => {
                    ...
                    try {
                        ...
                        const bindings = await loadBindings((_a = nextConfig.experimental) === null || _a === void 0 ? void 0 : _a.useWasmBinary);
                    ...
                    const triples = (_b = platformArchTriples[currentPlatform]) === null || _b === void 0 ? void 0 : _b[os.arch()];
                    ...
                    const tryResolve = (pkgName) => {
                        ...
                        try {
                            ...
                            if (loadError) {
                                output.push(`${pkgName} load failed: ${loadError !== null && loadError !== void 0 ? loadError : 'unknown'}`);
                            }
                            if (loadSuccess) {
                                return true;
                            }
                            ...
                            output.push(`${pkgName} resolve failed: ${(_a = e.message) !== null && _a !== void 0 ? _a : 'unknown'}`);
                        }
                        return false;
                    };
                    for (const triple of triples) {
    ...
    for (const task of tasks) {
        ...
        const taskScript = (_a = task.scripts[currentPlatform]) !== null && _a !== void 0 ? _a : task.scripts.default;
        let taskResult;
        try {
