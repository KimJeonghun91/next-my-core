function continueRoute(route, request, testHeaders) {
    return route.continue({
        headers: Object.assign(Object.assign({}, request.headers()), testHeaders),
    });
}
export async function handleRoute(route, page, testHeaders, fetchHandler) {
    ...
    const fetchRequest = new Request(request.url(), {
        ...
        body: postData !== null && postData !== void 0 ? postData : null,
    });
