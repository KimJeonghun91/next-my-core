...
export async function exportAppRoute(req, res, params, page, incrementalCache, distDir, htmlFilepath, fileWriter) {
    ...
    try {
        ...
        const revalidate = ((_a = context.renderOpts.store) === null || _a === void 0 ? void 0 : _a.revalidate) || false;
        ...
        await fileWriter(ExportedAppRouteFiles.BODY, htmlFilepath.replace(/\.html$/, NEXT_BODY_SUFFIX), body, 'utf8');
        // Write the request metadata to a file.
        const meta = { status: response.status, headers };
        await fileWriter(ExportedAppRouteFiles.META, htmlFilepath.replace(/\.html$/, NEXT_META_SUFFIX), JSON.stringify(meta));
        return {
