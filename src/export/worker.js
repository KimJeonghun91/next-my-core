...
async function exportPageImpl(input, fileWriter) {
    ...
    try {
        ...
        if (trailingSlash && !((_a = req.url) === null || _a === void 0 ? void 0 : _a.endsWith('/'))) {
            req.url += '/';
        }
        if (locale &&
            buildExport &&
            input.renderOpts.domainLocales &&
            input.renderOpts.domainLocales.some((dl) => { var _a; return dl.defaultLocale === locale || ((_a = dl.locales) === null || _a === void 0 ? void 0 : _a.includes(locale || '')); })) {
        ...
        const incrementalCache = isAppDir && fetchCache
        ...
        const renderOpts = Object.assign(Object.assign(Object.assign({}, components), input.renderOpts), { ampPath: renderAmpPath, params,
            optimizeFonts,
            optimizeCss,
            disableOptimizedLoading, fontManifest: optimizeFonts ? requireFontManifest(distDir) : undefined, locale, supportsDynamicHTML: false, originalPathname: page });
        if (hasNextSupport) {
