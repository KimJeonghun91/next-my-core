...
function defaultImageLoader(loaderProps) {
    var _a;
    const loaderKey = ((_a = loaderProps.config) === null || _a === void 0 ? void 0 : _a.loader) || 'default';
...
function handleLoading(img, src, layout, placeholder, onLoadingCompleteRef, setBlurComplete) {
    ...
    p.catch(() => { }).then(() => {
        ...
        if (process.env.NODE_ENV !== 'production') {
            if ((_a = img.parentElement) === null || _a === void 0 ? void 0 : _a.parentElement) {
...
const ImageElement = (_a) => {
    var { imgAttributes, heightInt, widthInt, qualityInt, layout, className, imgStyle, blurStyle, isLazy, placeholder, loading, srcString, config, unoptimized, loader, onLoadingCompleteRef, setBlurComplete, setIntersection, onLoad, onError, isVisible, noscriptSizes } = _a, rest = __rest(_a, ["imgAttributes", "heightInt", "widthInt", "qualityInt", "layout", "className", "imgStyle", "blurStyle", "isLazy", "placeholder", "loading", "srcString", "config", "unoptimized", "loader", "onLoadingCompleteRef", "setBlurComplete", "setIntersection", "onLoad", "onError", "isVisible", "noscriptSizes"]);
    loading = isLazy ? 'lazy' : loading;
    return (_jsxs(_Fragment, { children: [_jsx("img", Object.assign({}, rest, imgAttributes, { decoding: "async", "data-nimg": layout, className: className, style: Object.assign(Object.assign({}, imgStyle), blurStyle), ref: useCallback((img) => {
                    if (process.env.NODE_ENV !== 'production') {
                        if (img && !srcString) {
                ...
                } })), (isLazy || placeholder === 'blur') && (_jsx("noscript", { children: _jsx("img", Object.assign({}, rest, { 
                    // @ts-ignore - TODO: upgrade to `@types/react@17`
                    loading: loading, decoding: "async", "data-nimg": layout, style: imgStyle, className: className }, generateImgAttrs({
                    config,
                    src: srcString,
                    unoptimized,
                    layout,
...
export default function Image(_a) {
    var { src, sizes, unoptimized = false, priority = false, loading, lazyRoot = null, lazyBoundary, className, quality, width, height, style, objectFit, objectPosition, onLoadingComplete, placeholder = 'empty', blurDataURL } = _a, all = __rest(_a, ["src", "sizes", "unoptimized", "priority", "loading", "lazyRoot", "lazyBoundary", "className", "quality", "width", "height", "style", "objectFit", "objectPosition", "onLoadingComplete", "placeholder", "blurDataURL"]);
    const configContext = useContext(ImageConfigContext);
    const config = useMemo(() => {
        const c = configEnv || configContext || imageConfigDefault;
        const allSizes = [...c.deviceSizes, ...c.imageSizes].sort((a, b) => a - b);
        const deviceSizes = c.deviceSizes.sort((a, b) => a - b);
        return Object.assign(Object.assign({}, c), { allSizes, deviceSizes });
    }, [configContext]);
    let rest = all;
    ...
    if ('loader' in rest) {
        if (rest.loader) {
            ...
            loader = (obj) => {
                const { config: _ } = obj, opts = __rest(obj
    ...
    if (process.env.NODE_ENV !== 'production') {
        if (!src) {
            ...
            if ((typeof widthInt !== 'undefined' && isNaN(widthInt)) ||
            ...
            if (typeof window !== 'undefined' &&
                ...
                perfObserver = new PerformanceObserver((entryList) => {
                    ...
                    for (const entry of entryList.getEntries()) {
                        ...
                        const imgSrc = ((_a = entry === null || entry === void 0 ? void 0 : entry.element) === null || _a === void 0 ? void 0 : _a.src) || '';
    ...
    const imgElementArgs = Object.assign({ isLazy,
        imgAttributes,
        heightInt,
        widthInt,
        qualityInt,
        ...
        setBlurComplete,
        setIntersection,
        isVisible, noscriptSizes: sizes }, rest);
    return (_jsxs(_Fragment, { children: [_jsxs("span", { style: wrapperStyle, children: [hasSizer ? (_jsx("span", { style: sizerStyle, children: sizerSvgUrl ? (_jsx("img", { style: {
                                display: 'block',
                                maxWidth: '100%',
                                width: 'initial',
                                height: 'initial',
                                ...
                                margin: 0,
                                padding: 0,
                            }, alt: "", "aria-hidden": true, src: sizerSvgUrl })) : null })) : null, _jsx(ImageElement, Object.assign({}, imgElementArgs))] }), priority ? (
            // Note how we omit the `href` attribute, as it would only be relevant
            // for browsers that do not support `imagesrcset`, and in those cases
            // it would likely cause the incorrect image to be preloaded.
            //
            // https://html.spec.whatwg.org/multipage/semantics.html#attr-link-imagesrcset
            _jsx(Head, { children: _jsx("link", Object.assign({ rel: "preload", as: "image", href: imgAttributes.srcSet ? undefined : imgAttributes.src }, linkProps), '__nimg-' +
                    imgAttributes.src +
                    imgAttributes.srcSet +
                    imgAttributes.sizes) })) : null] }));
}
