...
function fastRefreshReducerImpl(state, action) {
    ...
    cache.lazyData = fetchServerResponse(new URL(href, origin), [state.tree[0], state.tree[1], state.tree[2], 'refetch'], state.nextUrl, state.buildId);
    return cache.lazyData.then(([flightData, canonicalUrlOverride]) => {
...
export const fastRefreshReducer = process.env.NODE_ENV === 'production'
