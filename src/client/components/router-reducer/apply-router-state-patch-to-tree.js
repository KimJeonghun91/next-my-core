 ...
 */
function applyPatch(initialTree, patchTree, applyPatchToDefaultSegment = false) {
...
function applyRouterStatePatchToTreeImpl(flightSegmentPath, flightRouterState, treePatch, applyPatchDefaultSegment = false) {
    ...
    const tree = [
        flightSegmentPath[0],
        Object.assign(Object.assign({}, parallelRoutes), { [parallelRouteKey]: parallelRoutePatch }),
    ];
