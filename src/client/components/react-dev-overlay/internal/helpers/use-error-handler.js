...
function isHydrationError(error) {
    return (error.message.match(/(hydration|content does not match|did not match)/i) !=
        null);
}
...
if (typeof window !== 'undefined') {
    ...
    window.addEventListener('error', (ev) => {
        ...
        if (isHydrationError(error) &&
            !error.message.includes('https://nextjs.org/docs/messages/react-hydration-error')) {
