...
export function useTurbopack(sendMessage) {
    ...
    const processTurbopackMessage = useCallback((msg) => {
        var _a;
        if ('type' in msg && ((_a = msg.type) === null || _a === void 0 ? void 0 : _a.startsWith('turbopack-'))) {
    ...
    useEffect(() => {
        ...
        '@vercel/turbopack-ecmascript-runtime/dev/client/hmr-client.ts').then(({ connect }) => {
