...
export default function HotReload({ assetPrefix, children, }) {
    ...
    useEffect(() => {
        const handler = (event) => {
            ...
            try {
                ...
                const handledByTurbopack = processTurbopackMessage === null || processTurbopackMessage === void 0 ? void 0 : processTurbopackMessage(obj);
    ...
    return (_jsx(ReactDevOverlay, { onReactError: handleOnReactError, state: state, children: children }));
}
