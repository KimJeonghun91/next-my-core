...
export function useParams() {
    ...
    return useMemo(() => {
        ...
        if (globalLayoutRouter === null || globalLayoutRouter === void 0 ? void 0 : globalLayoutRouter.tree) {
            return getSelectedParams(globalLayoutRouter.tree);
        }
        // When it's under client side pages router
        return pathParams;
    }, [globalLayoutRouter === null || globalLayoutRouter === void 0 ? void 0 : globalLayoutRouter.tree, pathParams]);
}
...
function getSelectedLayoutSegmentPath(tree, parallelRouteKey, first = true, segmentPath = []) {
    ...
    if (first) {
        ...
        const parallelRoutes = tree[1];
        node = (_a = parallelRoutes.children) !== null && _a !== void 0 ? _a : Object.values(parallelRoutes)[0];
    }
    if (!node)
        return segmentPath;
