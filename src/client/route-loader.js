    ...
    return {
        ...
        loadRoute(route, prefetch) {
            return withFuture(route, routes, () => {
                ...
                return resolvePromiseWithTimeout(getFilesForRoute(assetPrefix, route)
                    .then(({ scripts, css }) => {
                    return Promise.all([
                ...
                }), MS_MAX_IDLE_DELAY, markAssetError(new Error(`Route did not complete loading: ${route}`)))
                    .then(({ entrypoint, styles }) => {
                    const res = Object.assign({ styles: styles }, entrypoint);
        ...
        prefetch(route) {
            ...
            return getFilesForRoute(assetPrefix, route)
                .then((output) => Promise.all(canPrefetch
