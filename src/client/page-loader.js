...
import { DEV_CLIENT_PAGES_MANIFEST, DEV_MIDDLEWARE_MANIFEST, } from '../shared/lib/constants';
export default class PageLoader {
        ...
        if (process.env.NODE_ENV === 'production') {
            ...
            if (window.__DEV_MIDDLEWARE_MATCHERS) {
                ...
                if (!this.promisedMiddlewareMatchers) {
                    ...
                    // @ts-ignore
                    this.promisedMiddlewareMatchers = fetch(`${this.assetPrefix}/_next/static/${this.buildId}/${DEV_MIDDLEWARE_MANIFEST}`)
                        .then((res) => res.json())
                        .then((matchers) => {
    ...
    getDataHref(params) {
        ...
        return getHrefForSlug(params.skipInterpolation
            ? asPathname
