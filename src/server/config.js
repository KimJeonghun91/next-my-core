...
function assignDefaults(dir, userConfig, silent) {
    ...
    const config = Object.keys(userConfig).reduce((currentConfig, key) => {
        ...
        if (!!value && value.constructor === Object) {
            currentConfig[key] = Object.assign(Object.assign({}, defaultConfig[key]), Object.keys(value).reduce((c, k) => {
                const v = value[k];
    ...
    if ((_a = defaultConfig.experimental) === null || _a === void 0 ? void 0 : _a.ppr) {
        Log.warn(`\`experimental.ppr\` has been defaulted to \`true\` because \`__NEXT_EXPERIMENTAL_PPR\` was set to \`true\` during testing.`);
    }
    const result = Object.assign(Object.assign({}, defaultConfig), config);
    if (((_b = result.experimental) === null || _b === void 0 ? void 0 : _b.ppr) &&
    ...
    if (Array.isArray((_c = result.experimental) === null || _c === void 0 ? void 0 : _c.outputFileTracingIgnores)) {
    ...
    if (result.basePath !== '') {
        ...
        if (result.basePath !== '/') {
            ...
            if (((_d = result.amp) === null || _d === void 0 ? void 0 : _d.canonicalBase) === '') {
    ...
    if (result === null || result === void 0 ? void 0 : result.images) {
        ...
        if (images.remotePatterns) {
            ...
            // this resource
            if ((_e = config.assetPrefix) === null || _e === void 0 ? void 0 : _e.startsWith('http')) {
                try {
                    ...
                    if (!hasMatchForAssetPrefix) {
                        (_f = images.remotePatterns) === null || _f === void 0 ? void 0 : _f.push({
    ...
    if ((_g = result.experimental) === null || _g === void 0 ? void 0 : _g.incrementalCacheHandlerPath) {
    ...
    if ((_h = result.experimental) === null || _h === void 0 ? void 0 : _h.isrMemoryCacheSize) {
        // TODO: Remove this warning in Next.js 15
    ...
    if (typeof ((_j = result.experimental) === null || _j === void 0 ? void 0 : _j.serverActions) === 'boolean') {
        // TODO: Remove this warning in Next.js 15
    ...
    if (typeof ((_l = (_k = result.experimental) === null || _k === void 0 ? void 0 : _k.serverActions) === null || _l === void 0 ? void 0 : _l.bodySizeLimit) !== 'undefined') {
        const value = parseInt((_m = result.experimental.serverActions) === null || _m === void 0 ? void 0 : _m.bodySizeLimit.toString());
    ...
    if (((_o = result.experimental) === null || _o === void 0 ? void 0 : _o.outputFileTracingRoot) &&
    ...
    if (((_p = result.experimental) === null || _p === void 0 ? void 0 : _p.useDeploymentId) && process.env.NEXT_DEPLOYMENT_ID) {
        if (!result.experimental) {
            result.experimental = {};
        }
    ...
    if ((_q = result.experimental) === null || _q === void 0 ? void 0 : _q.useDeploymentIdServerActions) {
        result.experimental.useDeploymentId = true;
    }
    // use the closest lockfile as tracing root
    if (!((_r = result.experimental) === null || _r === void 0 ? void 0 : _r.outputFileTracingRoot)) {
    ...
    if ((_s = result.devIndicators) === null || _s === void 0 ? void 0 : _s.buildActivityPosition) {
    ...
    result.modularizeImports = Object.assign(Object.assign({}, (userProvidedModularizeImports || {})), { 
    ...
    const userProvidedOptimizePackageImports = ((_t = result.experimental) === null || _t === void 0 ? void 0 : _t.optimizePackageImports) || [];
    if (!result.experimental) {
        result.experimental = {};
    }
...
export default async function loadConfig(phase, dir, { customConfig, rawConfig, silent = true, onLoadUserConfig, } = {}) {
    ...
    if (customConfig) {
        return assignDefaults(dir, Object.assign({ configOrigin: 'server', configFileName }, customConfig), silent);
    }
    ...
    if (path === null || path === void 0 ? void 0 : path.length) {
        ...
        if (((_c = (_b = userConfig.experimental) === null || _b === void 0 ? void 0 : _b.turbo) === null || _c === void 0 ? void 0 : _c.loaders) &&
            !((_e = (_d = userConfig.experimental) === null || _d === void 0 ? void 0 : _d.turbo) === null || _e === void 0 ? void 0 : _e.rules)) {
        ...
        onLoadUserConfig === null || onLoadUserConfig === void 0 ? void 0 : onLoadUserConfig(userConfig);
        const completeConfig = assignDefaults(dir, Object.assign({ configOrigin: relative(dir, path), configFile: path, configFileName }, userConfig), silent);
