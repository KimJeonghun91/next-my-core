    ...
    res.setHeader(`Set-Cookie`, [
        ...(typeof previous === 'string'
            ...
            : Array.isArray(previous)
                ? previous
                : []),
        serialize(COOKIE_NAME_PRERENDER_BYPASS, options.previewModeId, Object.assign(Object.assign({ httpOnly: true, sameSite: process.env.NODE_ENV !== 'development' ? 'none' : 'lax', secure: process.env.NODE_ENV !== 'development', path: '/' }, (options.maxAge !== undefined
            ? { maxAge: options.maxAge }
            : undefined)), (options.path !== undefined
            ? { path: options.path }
            : undefined))),
        serialize(COOKIE_NAME_PRERENDER_DATA, payload, Object.assign(Object.assign({ httpOnly: true, sameSite: process.env.NODE_ENV !== 'development' ? 'none' : 'lax', secure: process.env.NODE_ENV !== 'development', path: '/' }, (options.maxAge !== undefined
            ? { maxAge: options.maxAge }
            : undefined)), (options.path !== undefined
            ? { path: options.path }
            : undefined))),
...
async function revalidate(urlPath, opts, req, context) {
    ...
    const revalidateHeaders = Object.assign({ [PRERENDER_REVALIDATE_HEADER]: context.previewModeId }, (opts.unstable_onlyGenerated
        ? {
...
export async function apiResolver(req, res, query, resolverModule, apiContext, propagateError, dev, page) {
    ...
    try {
        ...
        const responseLimit = (_c = (_b = config.api) === null || _b === void 0 ? void 0 : _b.responseLimit) !== null && _c !== void 0 ? _c : true;
        const externalResolver = ((_d = config.api) === null || _d === void 0 ? void 0 : _d.externalResolver) || false;
        // Parsing of cookies
        ...
        apiRes.setDraftMode = (options = { enable: true }) => setDraftMode(apiRes, Object.assign({}, apiContext, options));
        ...
        (_e = getTracer().getRootSpanAttributes()) === null || _e === void 0 ? void 0 : _e.set('next.route', page);
