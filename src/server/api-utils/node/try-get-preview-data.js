...
export function tryGetPreviewData(req, res, options) {
    ...
    const previewModeId = (_a = cookies.get(COOKIE_NAME_PRERENDER_BYPASS)) === null || _a === void 0 ? void 0 : _a.value;
    const tokenPreviewData = (_b = cookies.get(COOKIE_NAME_PRERENDER_DATA)) === null || _b === void 0 ? void 0 : _b.value;
