...
export function getMaybePagePath(page, distDir, locales, isAppPath) {
    ...
    let pagePath = pagePathCache === null || pagePathCache === void 0 ? void 0 : pagePathCache.get(cacheKey);
    ...
    if (!pagePath) {
        pagePathCache === null || pagePathCache === void 0 ? void 0 : pagePathCache.set(cacheKey, null);
        return null;
    }
    pagePath = path.join(serverBuildPath, pagePath);
    pagePathCache === null || pagePathCache === void 0 ? void 0 : pagePathCache.set(cacheKey, pagePath);
    return pagePath;
}
