export const StaticGenerationAsyncStorageWrapper = {
    wrap(storage, { urlPathname, renderOpts, postpone }, callback) {
         ...
         */
        const isStaticGeneration = !renderOpts.supportsDynamicHTML &&
        ...
        const store = {
            ...
            isStaticGeneration && renderOpts.experimental.ppr && postpone
                ? (reason) => {
                    ...
                    return postpone(`This page needs to bail out of prerendering at this point because it used ${reason}. ` +
