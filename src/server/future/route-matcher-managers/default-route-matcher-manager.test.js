...
describe('DefaultRouteMatcherManager', () => {
    ...
    it.each([
    ...
    ])('can handle locale aware matchers for $pathname and locale $options.i18n.detectedLocale', async ({ pathname, options, definition }) => {
        const manager = new DefaultRouteMatcherManager();
        ...
        expect(match === null || match === void 0 ? void 0 : match.definition).toBe(definition);
    });
