...
describe('I18NProvider', () => {
    ...
    describe('detectDomainLocale', () => {
        it.each([
            ...
            // Verify that the other detected locale will support the domain.
            {
                ...
                expected: config.domains.find((domainLocale) => { var _a; return (_a = domainLocale.locales) === null || _a === void 0 ? void 0 : _a.includes('en-CA'); }),
            },
    ...
    describe('analyze', () => {
        ...
        ])('for pathname $pathname and defaultLocale $defaultLocale', ({ pathname, defaultLocale, expected }) => {
