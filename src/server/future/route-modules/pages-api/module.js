...
export class PagesAPIRouteModule extends RouteModule {
    ...
    async render(req, res, context) {
        await apiResolver(req, res, context.query, this.userland, Object.assign(Object.assign({}, context.previewProps), { revalidate: context.revalidate, trustHostHeader: context.trustHostHeader, allowedRevalidateHeaderKeys: context.allowedRevalidateHeaderKeys, hostname: context.hostname }), context.minimalMode, context.dev, context.page);
    }
}
