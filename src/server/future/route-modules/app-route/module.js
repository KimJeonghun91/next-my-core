...
export class AppRouteRouteModule extends RouteModule {
    ...
    async execute(request, context) {
        ...
        const response = await this.actionAsyncStorage.run({
            ...
            (_a = staticGenerationStore.revalidate) !== null && _a !== void 0 ? _a : (staticGenerationStore.revalidate = (_b = this.userland.revalidate) !== null && _b !== void 0 ? _b : false);
            // Wrap the request so we can add additional functionality to cases
            // that might change it's output or affect the rendering.
            const wrappedRequest = proxyRequest(request, { dynamic: this.dynamic }, {
            ...
            (_c = getTracer().getRootSpanAttributes()) === null || _c === void 0 ? void 0 : _c.set('next.route', route);
            return getTracer().trace(AppRouteRouteHandlersSpan.runHandler, {
                ...
                context.renderOpts.fetchTags =
                    (_a = staticGenerationStore.tags) === null || _a === void 0 ? void 0 : _a.join(',');
...
AppRouteRouteModule.sharedModules = sharedModules;
