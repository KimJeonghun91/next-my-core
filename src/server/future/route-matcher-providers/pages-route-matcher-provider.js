...
export class PagesRouteMatcherProvider extends ManifestRouteMatcherProvider {
    ...
    async transform(manifest) {
        ...
        const pathnames = Object.keys(manifest)
            ...
            .filter((pathname) => {
            var _a, _b;
            const normalized = (_b = (_a = this.i18nProvider) === null || _a === void 0 ? void 0 : _a.analyze(pathname).pathname) !== null && _b !== void 0 ? _b : pathname;
            // Skip any blocked pages.
            if (BLOCKED_PAGES.includes(normalized))
                return false;
            return true;
        });
        const matchers = [];
