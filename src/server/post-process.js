    ...
    const postProcessors = [
        ...
        process.env.NEXT_RUNTIME !== 'edge' && renderOpts.optimizeFonts
            ? async (html) => {
                const getFontDefinition = (url) => {
                    ...
                    return (((_a = renderOpts.fontManifest.find((font) => {
                ...
                return await processHTML(html, { getFontDefinition }, {
        ...
        process.env.NEXT_RUNTIME !== 'edge' && renderOpts.optimizeCss
            ? async (html) => {
                ...
                const cssOptimizer = new Critters(Object.assign({ ssrMode: true, reduceInlineStyles: false, path: renderOpts.distDir, publicPath: `${renderOpts.assetPrefix}/_next/`, preload: 'media', fonts: false }, renderOpts.optimizeCss));
