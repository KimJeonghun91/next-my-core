...
export function getUtils({ page, i18n, basePath, rewrites, pageIsDynamic, trailingSlash, caseSensitive, }) {
    ...
    function handleRewrites(req, parsedUrl) {
        ...
        const matchesPage = () => {
            ...
            return (fsPathnameNoSlash === removeTrailingSlash(page) ||
                (dynamicRouteMatcher === null || dynamicRouteMatcher === void 0 ? void 0 : dynamicRouteMatcher(fsPathnameNoSlash)));
        };
        const checkRewrite = (rewrite) => {
            ...
            if (params) {
                ...
                if (pageIsDynamic && dynamicRouteMatcher) {
                    ...
                    if (dynamicParams) {
                        parsedUrl.query = Object.assign(Object.assign({}, parsedUrl.query), dynamicParams);
                        return true;
                    }
                }
            }
