...
export class EdgeRouteModuleWrapper {
    ...
    static wrap(routeModule, options = {}) {
        ...
        return (opts) => {
            return adapter(Object.assign(Object.assign(Object.assign({}, opts), options), { IncrementalCache, 
    ...
    async handler(request, evt) {
        ...
        const context = {
            ...
            prerenderManifest: {
                ...
                routes: {},
                dynamicRoutes: {},
                preview: (prerenderManifest === null || prerenderManifest === void 0 ? void 0 : prerenderManifest.preview) || {
