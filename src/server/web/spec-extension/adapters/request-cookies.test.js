...
import { ReadonlyRequestCookiesError, RequestCookiesAdapter, } from './request-cookies';
describe('RequestCookiesAdapter', () => {
    it('should be able to create a new instance from a RequestCookies', () => {
        ...
        expect(() => sealed.set('foo', 'bar2')).toThrowError(ReadonlyRequestCookiesError);
        expect(() => sealed.delete('foo')).toThrowError(ReadonlyRequestCookiesError);
        expect(() => sealed.clear()).toThrowError(ReadonlyRequestCookiesError);
