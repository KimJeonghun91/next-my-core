...
export function unstable_cache(cb, keyParts, options = {}) {
    var _a, _b;
    const staticGenerationAsyncStorage = ((_b = (_a = fetch).__nextGetStaticStore) === null || _b === void 0 ? void 0 : _b.call(_a)) || _staticGenerationAsyncStorage;
    ...
    const cachedCb = async (...args) => {
        ...
        const maybeIncrementalCache = (store === null || store === void 0 ? void 0 : store.incrementalCache) || globalThis.__incrementalCache;
        ...
        const fetchIdx = (_a = (store ? store.nextFetchId : noStoreFetchIdx)) !== null && _a !== void 0 ? _a : 1;
        if (store) {
            ...
            if (typeof options.revalidate === 'number') {
                if (typeof store.revalidate === 'number' &&
            ...
            const result = await staticGenerationAsyncStorage.run(Object.assign(Object.assign({}, store), { 
                // force any nested fetches to bypass cache so they revalidate
                // when the unstable_cache call is revalidated
                fetchCache: 'force-no-store', isUnstableCacheCallback: true }), cb, ...args);
