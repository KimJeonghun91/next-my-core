...
export default class Server {
    constructor(options) {
        ...
        this.handleRSCRequest = (req, _res, parsedUrl) => {
            ...
            if (!parsedUrl.pathname)
                return false;
            if ((_a = this.normalizers.prefetchRSC) === null || _a === void 0 ? void 0 : _a.match(parsedUrl.pathname)) {
            ...
            else if ((_b = this.normalizers.rsc) === null || _b === void 0 ? void 0 : _b.match(parsedUrl.pathname)) {
        ...
        this.handleNextDataRequest = async (req, res, parsedUrl) => {
            ...
            if (this.i18nProvider) {
                ...
                const hostname = (_a = req === null || req === void 0 ? void 0 : req.headers.host) === null || _a === void 0 ? void 0 : _a.split(':', 1)[0].toLowerCase();
                const domainLocale = this.i18nProvider.detectDomainLocale(hostname);
                const defaultLocale = (_b = domainLocale === null || domainLocale === void 0 ? void 0 : domainLocale.defaultLocale) !== null && _b !== void 0 ? _b : this.i18nProvider.config.defaultLocale;
        ...
        this.i18nProvider = ((_a = this.nextConfig.i18n) === null || _a === void 0 ? void 0 : _a.locales)
        ...
        this.normalizers = {
            ...
            postponed: this.enabledDirectories.app &&
                this.nextConfig.experimental.ppr &&
                this.minimalMode
                ? new PostponedPathnameNormalizer()
                : undefined,
            rsc: this.enabledDirectories.app && this.minimalMode
                ? new RSCPathnameNormalizer()
                : undefined,
            prefetchRSC: this.enabledDirectories.app &&
                this.nextConfig.experimental.ppr &&
                this.minimalMode
        ...
        this.renderOpts = {
            ...
            ampOptimizerConfig: (_b = this.nextConfig.experimental.amp) === null || _b === void 0 ? void 0 : _b.optimizer,
            basePath: this.nextConfig.basePath,
            images: this.nextConfig.images,
            optimizeFonts: this.nextConfig.optimizeFonts,
            fontManifest: this.nextConfig.optimizeFonts && !dev
            ...
            domainLocales: (_c = this.nextConfig.i18n) === null || _c === void 0 ? void 0 : _c.domains,
            ...
            runtimeConfig: Object.keys(publicRuntimeConfig).length > 0
                ? publicRuntimeConfig
                : undefined,
            // @ts-expect-error internal field not publicly exposed
            isExperimentalCompile: this.nextConfig.experimental.isExperimentalCompile,
            experimental: {
                ppr: this.enabledDirectories.app &&
    ...
    getRouteMatchers() {
        ...
        const manifestLoader = new ServerManifestLoader((name) => {
            ...
            switch (name) {
                case PAGES_MANIFEST:
                    return (_a = this.getPagesManifest()) !== null && _a !== void 0 ? _a : null;
                case APP_PATHS_MANIFEST:
                    return (_b = this.getAppPathsManifest()) !== null && _b !== void 0 ? _b : null;
                default:
                    return null;
            }
        });
        ...
        return tracer.withPropagatedContext(req.headers, () => {
            return tracer.trace(BaseServerSpan.handleRequest, {
                ...
                if (!rootSpanAttributes)
                    return;
                if (rootSpanAttributes.get('next.span_type') !==
    ...
    async handleRequestImpl(req, res, parsedUrl) {
        ...
        try {
            ...
            (_d = (_w = req.headers)['x-forwarded-host']) !== null && _d !== void 0 ? _d : (_w['x-forwarded-host'] = (_e = req.headers['host']) !== null && _e !== void 0 ? _e : this.hostname);
            (_f = (_x = req.headers)['x-forwarded-port']) !== null && _f !== void 0 ? _f : (_x['x-forwarded-port'] = (_g = this.port) === null || _g === void 0 ? void 0 : _g.toString());
            const { originalRequest } = req;
            (_h = (_y = req.headers)['x-forwarded-proto']) !== null && _h !== void 0 ? _h : (_y['x-forwarded-proto'] = ((_j = originalRequest.socket) === null || _j === void 0 ? void 0 : _j.encrypted)
                ? 'https'
                : 'http');
            (_k = (_z = req.headers)['x-forwarded-for']) !== null && _k !== void 0 ? _k : (_z['x-forwarded-for'] = (_l = originalRequest.socket) === null || _l === void 0 ? void 0 : _l.remoteAddress);
            ...
            const domainLocale = (_m = this.i18nProvider) === null || _m === void 0 ? void 0 : _m.detectDomainLocale(getHostname(parsedUrl, req.headers));
            const defaultLocale = (domainLocale === null || domainLocale === void 0 ? void 0 : domainLocale.defaultLocale) || ((_o = this.nextConfig.i18n) === null || _o === void 0 ? void 0 : _o.defaultLocale);
            parsedUrl.query.__nextDefaultLocale = defaultLocale;
            ...
            if (useMatchedPathHeader) {
                try {
                    ...
                    if ((_p = this.normalizers.data) === null || _p === void 0 ? void 0 : _p.match(urlPathname)) {
                        parsedUrl.query.__nextDataReq = '1';
                    }
                    ...
                    // the matched path is a postponed path, and if it is, handle it.
                    else if (((_q = this.normalizers.postponed) === null || _q === void 0 ? void 0 : _q.match(matchedPath)) &&
                        req.method === 'POST') {
                        ...
                        const body = [];
                        try {
                            for (var _0 = true, _1 = __asyncValues(req.body), _2; _2 = await _1.next(), _a = _2.done, !_a; _0 = true) {
                                _c = _2.value;
                                _0 = false;
                                const chunk = _c;
                                body.push(chunk);
                    ...
                    const localeAnalysisResult = (_r = this.i18nProvider) === null || _r === void 0 ? void 0 : _r.analyze(matchedPath, {
                        defaultLocale,
                    });
                    ...
                    const utils = getUtils({
                        ...
                        basePath: this.nextConfig.basePath,
                        rewrites: ((_s = this.getRoutesManifest()) === null || _s === void 0 ? void 0 : _s.rewrites) || {
                            beforeFiles: [],
                            afterFiles: [],
                            fallback: [],
                        },
                    ...
                    for (const key of Object.keys(parsedUrl.query)) {
                        ...
                        if (key !== NEXT_QUERY_PARAM_PREFIX &&
                    ...
                    if (pageIsDynamic) {
                        ...
                        if (!paramsResult.hasValidParams &&
                            ...
                            let matcherParams = (_t = utils.dynamicRouteMatcher) === null || _t === void 0 ? void 0 : _t.call(utils, normalizedUrlPath);
                            if (matcherParams) {
                        ...
                        if (pageIsDynamic &&
                            ...
                            !paramsResult.hasValidParams &&
                            !utils.normalizeDynamicRouteParams(Object.assign({}, params), true)
                                .hasValidParams) {
                    ...
                    if (pageIsDynamic || didRewrite) {
                        utils.normalizeVercelUrl(req, true, [
                            ...rewriteParamKeys,
                            ...Object.keys(((_u = utils.defaultRouteRegex) === null || _u === void 0 ? void 0 : _u.groups) || {}),
                        ]);
                    }
            ...
            process.env.NEXT_RUNTIME !== 'edge' &&
                ...
                const redirect = getLocaleRedirect({
                    ...
                    urlParsed: Object.assign(Object.assign({}, url), { pathname: pathnameInfo.locale
            ...
            const useInvokePath = !useMatchedPathHeader &&
                process.env.NEXT_RUNTIME !== 'edge' &&
                invokePath;
            if (useInvokePath) {
                ...
                const normalizeResult = normalizeLocalePath(removePathPrefix(parsedUrl.pathname, this.nextConfig.basePath || ''), ((_v = this.nextConfig.i18n) === null || _v === void 0 ? void 0 : _v.locales) || []);
    ...
    async pipeImpl(fn, partialContext) {
        ...
        const ctx = Object.assign(Object.assign({}, partialContext), { renderOpts: Object.assign(Object.assign({}, this.renderOpts), { supportsDynamicHTML: !isBotRequest, isBot: !!isBotRequest }) });
    ...
    async getStaticHTML(fn, partialContext) {
        const ctx = Object.assign(Object.assign({}, partialContext), { renderOpts: Object.assign(Object.assign({}, this.renderOpts), { supportsDynamicHTML: false }) });
        const payload = await fn(ctx);
        if (payload === null) {
            return null;
        }
    ...
    async renderImpl(req, res, pathname, query = {}, parsedUrl, internalRender = false) {
        ...
        if (!internalRender &&
            !this.minimalMode &&
            !query.__nextDataReq &&
            (((_a = req.url) === null || _a === void 0 ? void 0 : _a.match(/^\/_next\//)) ||
    ...
    async getStaticPaths({ pathname, }) {
        ...
        const fallbackField = (_a = this.getPrerenderManifest().dynamicRoutes[pathname]) === null || _a === void 0 ? void 0 : _a.fallback;
        return {
            // `staticPaths` is intentionally set to `undefined` as it should've
            // been caught when checking disk data.
            staticPaths: undefined,
            fallbackMode: typeof fallbackField === 'string'
                ? 'static'
                : fallbackField === null
                    ? 'blocking'
                    : fallbackField,
    ...
    stripInternalHeaders(req) {
        ...
        if ('originalRequest' in req &&
            'headers' in req.originalRequest) {
    ...
    async renderToResponseWithComponentsImpl({ req, res, pathname, renderOpts: opts }, { components, query }) {
        ...
        const hasGetInitialProps = !!((_a = components.Component) === null || _a === void 0 ? void 0 : _a.getInitialProps);
        ...
        if (isAppPath && isDynamic) {
            ...
            if (this.nextConfig.output === 'export') {
                ...
                if (!(staticPaths === null || staticPaths === void 0 ? void 0 : staticPaths.includes(resolvedWithoutSlash))) {
        ...
        if (hasFallback ||
            (staticPaths === null || staticPaths === void 0 ? void 0 : staticPaths.includes(resolvedUrlPathname)) ||
            ...
            isSSG || (isSSG = !!prerenderManifest.routes[pathname === '/index' ? '/' : pathname]);
        }
        // Toggle whether or not this is a Data request
        let isDataReq = !!(query.__nextDataReq ||
         ...
         * prefetch request.
         */
        const isPrefetchRSCRequest = (_b = (req.headers[NEXT_ROUTER_PREFETCH_HEADER.toLowerCase()] === '1' ||
            getRequestMeta(req, 'isPrefetchRSCRequest'))) !== null && _b !== void 0 ? _b : false;
        ...
        const isRSCRequest = (_c = (Boolean(req.headers[RSC_HEADER.toLowerCase()]) ||
            getRequestMeta(req, 'isRSCRequest'))) !== null && _c !== void 0 ? _c : false;
        ...
        if (opts.supportsDynamicHTML === true) {
            ...
            const isSupportedDocument = typeof ((_d = components.Document) === null || _d === void 0 ? void 0 : _d.getInitialProps) !== 'function' ||
        ...
        const defaultLocale = isSSG
            ? (_e = this.nextConfig.i18n) === null || _e === void 0 ? void 0 : _e.defaultLocale
            : query.__nextDefaultLocale;
        const locale = query.__nextLocale;
        const locales = (_f = this.nextConfig.i18n) === null || _f === void 0 ? void 0 : _f.locales;
        let previewData;
        ...
        if (!isPreviewMode &&
            ...
            !minimalPostponed &&
            !isDynamicRSCRequest) {
            ssgCacheKey = `${locale ? `/${locale}` : ''}${(pathname === '/' || resolvedUrlPathname === '/') && locale
                ? ''
        ...
        const incrementalCache = globalThis.__incrementalCache ||
            (await this.getIncrementalCache({
                requestHeaders: Object.assign({}, req.headers),
                requestProtocol: protocol.substring(0, protocol.length - 1),
            }));
        incrementalCache === null || incrementalCache === void 0 ? void 0 : incrementalCache.resetRequestCache();
        ...
        const doRender = async ({ postponed }) => {
            ...
            const renderOpts = Object.assign(Object.assign(Object.assign(Object.assign({}, components), opts), (isAppPath
                ? {
                    incrementalCache,
                ...
                // asPath
                resolvedAsPath: hasServerProps || hasGetInitialProps
                    ? formatUrl({
                    ...
                    : resolvedUrl, supportsDynamicHTML,
                isOnDemandRevalidate, isDraftMode: isPreviewMode, isServerAction,
                postponed });
                ...
                if (isAppRouteRouteModule(routeModule)) {
                    ...
                    try {
                        ...
                        if (isSSG && process.env.NEXT_RUNTIME !== 'edge') {
                            ...
                            const revalidate = (_b = (_a = context.renderOpts.store) === null || _a === void 0 ? void 0 : _a.revalidate) !== null && _b !== void 0 ? _b : false;
                    ...
                    result = await routeModule.render((_c = req.originalRequest) !== null && _c !== void 0 ? _c : req, (_d = res.originalResponse) !== null && _d !== void 0 ? _d : res, { page: pathname, params: opts.params, query, renderOpts });
                }
                    ...
                    renderOpts.nextFontManifest = this.nextFontManifest;
                    // Call the built-in render method on the module.
                    result = await module.render((_e = req.originalRequest) !== null && _e !== void 0 ? _e : req, (_f = res.originalResponse) !== null && _f !== void 0 ? _f : res, {
            ...
            if (isAppPath &&
                ...
                const err = new Error(`Page changed from static to dynamic at runtime ${urlPathname}${(staticBailoutInfo === null || staticBailoutInfo === void 0 ? void 0 : staticBailoutInfo.description)
                    ? `, reason: ${staticBailoutInfo.description}`
                    : ``}` +
                    `\nsee more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`);
                if (staticBailoutInfo === null || staticBailoutInfo === void 0 ? void 0 : staticBailoutInfo.stack) {
            ...
            if (metadata.isRedirect) {
                return {
                    value: {
                        kind: 'REDIRECT',
                        props: (_g = metadata.pageData) !== null && _g !== void 0 ? _g : metadata.flightData,
                    },
            ...
            return {
                value: {
                    kind: 'PAGE',
                    html: result,
                    pageData: (_h = metadata.pageData) !== null && _h !== void 0 ? _h : metadata.flightData,
        ...
        const cacheEntry = await this.responseCache.get(ssgCacheKey, async (hasResolved, previousCacheEntry, isRevalidating) => {
            ...
            if ((previousCacheEntry === null || previousCacheEntry === void 0 ? void 0 : previousCacheEntry.isStale) === -1) {
            ...
            let staticPathKey = ssgCacheKey !== null && ssgCacheKey !== void 0 ? ssgCacheKey : (opts.dev && isAppPath ? resolvedUrlPathname : null);
            if (staticPathKey && query.amp) {
                staticPathKey = staticPathKey.replace(/\.amp$/, '');
            }
            const isPageIncludedInStaticPaths = staticPathKey && (staticPaths === null || staticPaths === void 0 ? void 0 : staticPaths.includes(staticPathKey));
            ...
            if (process.env.NEXT_RUNTIME !== 'edge' &&
                ...
                // getStaticPaths.
                (isProduction || (staticPaths && (staticPaths === null || staticPaths === void 0 ? void 0 : staticPaths.length) > 0)) &&
            ...
            const result = await doRender({
                ...
                postponed: !isOnDemandRevalidate && !isRevalidating && minimalPostponed
                    ? minimalPostponed
                    : undefined,
            });
            if (!result) {
            ...
            return Object.assign(Object.assign({}, result), { revalidate: result.revalidate !== undefined
                    ? result.revalidate
                    : /* default to minimum revalidate (this should be an invariant) */ 1 });
        }, {
            routeKind: routeModule === null || routeModule === void 0 ? void 0 : routeModule.definition.kind,
            incrementalCache,
        ...
        const didPostpone = ((_g = cacheEntry.value) === null || _g === void 0 ? void 0 : _g.kind) === 'PAGE' && !!cacheEntry.value.postponed;
        if (isSSG &&
            !this.minimalMode &&
            ...
            res.setHeader('x-nextjs-cache', isOnDemandRevalidate
                ? 'REVALIDATED'
                : cacheEntry.isMiss
                    ? 'MISS'
                    : cacheEntry.isStale
        ...
        if ((cachedData === null || cachedData === void 0 ? void 0 : cachedData.kind) === 'IMAGE') {
        ...
        else if (typeof cacheEntry.revalidate !== 'undefined' &&
        ...
        if (!cachedData) {
            ...
            const headers = Object.assign({}, cachedData.headers);
            ...
            if (this.minimalMode &&
                isSSG &&
                ((_h = cachedData.headers) === null || _h === void 0 ? void 0 : _h[NEXT_CACHE_TAGS_HEADER])) {
            ...
            doRender({ postponed: cachedData.postponed })
                ...
                if (((_a = result.value) === null || _a === void 0 ? void 0 : _a.kind) !== 'PAGE') {
                    throw new Error(`Invariant: expected a page response, got ${(_b = result.value) === null || _b === void 0 ? void 0 : _b.kind}`);
                }
    ...
    getOriginalAppPaths(route) {
        var _a;
        if (this.enabledDirectories.app) {
            const originalAppPath = (_a = this.appPathRoutes) === null || _a === void 0 ? void 0 : _a[route];
            if (!originalAppPath) {
                return null;
            }
    ...
    async renderPageComponent(ctx, bubbleNoFallback) {
        ...
        const result = await this.findPageComponents({
            ...
            isAppPath,
            sriEnabled: !!((_a = this.nextConfig.experimental.sri) === null || _a === void 0 ? void 0 : _a.algorithm),
            appPaths,
    ...
    async renderToResponseImpl(ctx) {
        ...
        const options = {
            i18n: (_d = this.i18nProvider) === null || _d === void 0 ? void 0 : _d.fromQuery(pathname, query),
        };
        try {
            try {
                for (var _e = true, _f = __asyncValues(this.matchers.matchAll(pathname, options)), _g; _g = await _f.next(), _a = _g.done, !_a; _e = true) {
                    _c = _g.value;
                    _e = false;
                    const match = _c;
                    ...
                    const result = await this.renderPageComponent(Object.assign(Object.assign({}, ctx), { pathname: match.definition.pathname, renderOpts: Object.assign(Object.assign({}, ctx.renderOpts), { params: match.params }) }), bubbleNoFallback);
                    if (result !== false)
                        return result;
                }
            }
    ...
    async renderErrorToResponseImpl(ctx, err) {
        ...
        try {
            ...
            try {
                return await this.renderToResponseWithComponents(Object.assign(Object.assign({}, ctx), { pathname: statusPage, renderOpts: Object.assign(Object.assign({}, ctx.renderOpts), { err }) }), result);
            }
            ...
            if (fallbackComponents) {
                ...
                return this.renderToResponseWithComponents(Object.assign(Object.assign({}, ctx), { pathname: '/_error', renderOpts: Object.assign(Object.assign({}, ctx.renderOpts), { 
