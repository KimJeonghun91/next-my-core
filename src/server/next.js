...
export class NextServer {
    ...
    async [SYMBOL_LOAD_CONFIG]() {
        ...
        const config = this.options.preloadedConfig ||
            (await loadConfig(this.options.dev ? PHASE_DEVELOPMENT_SERVER : PHASE_PRODUCTION_SERVER, dir, {
    ...
    async getServer() {
        if (!this.serverPromise) {
            this.serverPromise = this[SYMBOL_LOAD_CONFIG]().then(async (conf) => {
                ...
                this.server = await this.createServer(Object.assign(Object.assign({}, this.options), { conf }));
...
class NextCustomServer extends NextServer {
    ...
    setupWebSocketHandler(customServer, _req) {
        ...
        if (!this.didWebSocketSetup) {
            ...
            customServer = customServer || ((_a = _req === null || _req === void 0 ? void 0 : _req.socket) === null || _a === void 0 ? void 0 : _a.server);
            if (customServer) {
    ...
    async render(...args) {
        ...
        req.url = formatUrl(Object.assign(Object.assign({}, parsedUrl), { pathname,
            query }));
...
function createServer(options) {
    ...
    if (!('isNextDevCommand' in options) &&
    ...
    if (options.customServer !== false) {
        ...
        return new NextCustomServer(Object.assign(Object.assign({}, options), { dir }));
    }
