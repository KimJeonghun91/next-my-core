...
export async function createComponentTree({ createSegmentPath, loaderTree: tree, parentParams, firstItem, rootLayoutIncluded, injectedCSS, injectedJS, injectedFontPreloadTags, asNotFound, metadataOutlet, ctx, missingSlots, }) {
    ...
    const [NotFound, notFoundStyles] = notFound
        ...
        : [];
    let dynamic = layoutOrPageMod === null || layoutOrPageMod === void 0 ? void 0 : layoutOrPageMod.dynamic;
    ...
    if (typeof (layoutOrPageMod === null || layoutOrPageMod === void 0 ? void 0 : layoutOrPageMod.fetchCache) === 'string') {
        staticGenerationStore.fetchCache = layoutOrPageMod === null || layoutOrPageMod === void 0 ? void 0 : layoutOrPageMod.fetchCache;
    }
    if (typeof (layoutOrPageMod === null || layoutOrPageMod === void 0 ? void 0 : layoutOrPageMod.revalidate) !== 'undefined') {
        validateRevalidate(layoutOrPageMod === null || layoutOrPageMod === void 0 ? void 0 : layoutOrPageMod.revalidate, staticGenerationStore.urlPathname);
    }
    if (typeof (layoutOrPageMod === null || layoutOrPageMod === void 0 ? void 0 : layoutOrPageMod.revalidate) === 'number') {
    ...
    if (hasSlotKey && rootLayoutAtThisLevel && LayoutOrPage) {
        Component = (componentProps) => {
            ...
            return (_jsx(NotFoundBoundary, { notFound: NotFoundComponent ? (_jsxs(_Fragment, { children: [layerAssets, _jsxs(RootLayoutComponent, { params: componentProps.params, children: [notFoundStyles, _jsx(NotFoundComponent, {})] })] })) : undefined, children: _jsx(RootLayoutComponent, Object.assign({}, componentProps)) }));
        };
    }
    if (process.env.NODE_ENV === 'development') {
        const { isValidElementType } = require('next/dist/compiled/react-is');
        if ((isPage || typeof Component !== 'undefined') &&
    ...
    segmentParam && segmentParam.value !== null
        ? Object.assign(Object.assign({}, parentParams), { [segmentParam.param]: segmentParam.value }) : // Pass through parent params to children
        parentParams;
    ...
    const parallelRouteMap = await Promise.all(Object.keys(parallelRoutes).map(async (parallelRouteKey) => {
        ...
        const notFoundComponent = NotFound && isChildrenRouteKey ? _jsx(NotFound, {}) : undefined;
        ...
        return [
            parallelRouteKey,
            _jsx(LayoutRouter, { parallelRouterKey: parallelRouteKey, segmentPath: createSegmentPath(currentSegmentPath), loading: Loading ? _jsx(Loading, {}) : undefined, loadingStyles: loadingStyles, loadingScripts: loadingScripts, 
                // TODO-APP: Add test for loading returning `undefined`. This currently can't be tested as the `webdriver()` tab will wait for the full page to load before returning.
                hasLoading: Boolean(Loading), error: ErrorComponent, errorStyles: errorStyles, errorScripts: errorScripts, template: _jsx(Template, { children: _jsx(RenderFromTemplateContext, {}) }), templateStyles: templateStyles, templateScripts: templateScripts, notFound: notFoundComponent, notFoundStyles: notFoundStyles, styles: currentStyles }),
    ...
    if (!Component) {
        return {
            seedData: [
                ...
                // caution, for now.
                _jsx(_Fragment, { children: parallelRouteProps.children }),
            ],
            styles: layerAssets,
        };
    }
    ...
    if (staticGenerationStore.forceDynamic && staticGenerationStore.postpone) {
        return {
            seedData: [
                actualSegment,
                parallelRouteCacheNodeSeedData,
                _jsx(Postpone, { postpone: staticGenerationStore.postpone }),
            ],
            styles: layerAssets,
        };
    }
    ...
    if (NotFound &&
        ...
        notFoundComponent = {
            children: (_jsxs(_Fragment, { children: [_jsx("meta", { name: "robots", content: "noindex" }), process.env.NODE_ENV === 'development' && (_jsx("meta", { name: "next-error", content: "not-found" })), notFoundStyles, _jsx(NotFound, {})] })),
        };
    }
    const props = Object.assign(Object.assign(Object.assign(Object.assign({}, parallelRouteProps), notFoundComponent), { 
    ...
    return {
        seedData: [
            actualSegment,
            parallelRouteCacheNodeSeedData,
            _jsxs(_Fragment, { children: [isPage ? metadataOutlet : null, isPage && isClientComponent ? (_jsx(StaticGenerationSearchParamsBailoutProvider, { propsForComponent: props, Component: Component, isStaticGeneration: staticGenerationStore.isStaticGeneration })) : (_jsx(Component, Object.assign({}, props))), null] }),
        ],
        styles: layerAssets,
    };
}
