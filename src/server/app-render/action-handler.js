...
function getForwardedHeaders(req, res) {
    ...
    const requestCookies = (_a = requestHeaders['cookie']) !== null && _a !== void 0 ? _a : '';
    ...
    const mergedHeaders = filterReqHeaders(Object.assign(Object.assign({}, nodeHeadersToRecord(requestHeaders)), nodeHeadersToRecord(responseHeaders)), actionsForbiddenHeaders);
    // Merge cookies
...
async function addRevalidationHeader(res, { staticGenerationStore, requestStore, }) {
    ...
    // is always empty.
    const isTagRevalidated = ((_a = staticGenerationStore.revalidatedTags) === null || _a === void 0 ? void 0 : _a.length) ? 1 : 0;
    const isCookieRevalidated = getModifiedCookieValues(requestStore.mutableCookies).length
        ? 1
        : 0;
...
async function createRedirectRenderResult(req, res, redirectUrl, basePath, staticGenerationStore) {
    ...
    if (redirectUrl.startsWith('/')) {
        ...
        const proto = ((_a = staticGenerationStore.incrementalCache) === null || _a === void 0 ? void 0 : _a.requestProtocol) || 'https';
        const fetchUrl = new URL(`${proto}://${host}${basePath}${redirectUrl}`);
        if (staticGenerationStore.revalidatedTags) {
            forwardedHeaders.set(NEXT_CACHE_REVALIDATED_TAGS_HEADER, staticGenerationStore.revalidatedTags.join(','));
            forwardedHeaders.set(NEXT_CACHE_REVALIDATE_TAG_TOKEN_HEADER, ((_d = (_c = (_b = staticGenerationStore.incrementalCache) === null || _b === void 0 ? void 0 : _b.prerenderManifest) === null || _c === void 0 ? void 0 : _c.preview) === null || _d === void 0 ? void 0 : _d.previewModeId) || '');
        }
...
export async function handleAction({ req, res, ComponentMod, serverModuleMap, generateFlight, staticGenerationStore, requestStore, serverActions, ctx, }) {
    ...
    if (!originDomain) {
        ...
        if (isCsrfOriginAllowed(originDomain, serverActions === null || serverActions === void 0 ? void 0 : serverActions.allowedOrigins)) {
            // Ignore it
        }
        else {
            if (host) {
        ...
        await actionAsyncStorage.run({ isAction: true }, async () => {
            ...
            if (process.env.NEXT_RUNTIME === 'edge') {
                ...
                if (isMultipartAction) {
                    ...
                    const readableLimit = (_d = serverActions === null || serverActions === void 0 ? void 0 : serverActions.bodySizeLimit) !== null && _d !== void 0 ? _d : '1 MB';
...
To configure the body size limit for Server Actions, see: https://nextjs.org/docs/app/api-reference/functions/server-actions#size-limitation`);
            ...
            try {
                actionModId =
                    actionModId !== null && actionModId !== void 0 ? actionModId : getActionModIdOrError(actionId, serverModuleMap);
            }
            catch (err) {
                console.error(err);
                return {
...
function getActionModIdOrError(actionId, serverModuleMap) {
    ...
    try {
        ...
        const actionModId = (_a = serverModuleMap === null || serverModuleMap === void 0 ? void 0 : serverModuleMap[actionId]) === null || _a === void 0 ? void 0 : _a.id;
        if (!actionModId) {
