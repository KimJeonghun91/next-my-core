...
const dynamicImportEsmDefault = process.env.NEXT_MINIMAL
    ? (id) => import(/* webpackIgnore: true */ id).then((mod) => mod.default || mod)
    : (id) => import(id).then((mod) => mod.default || mod);
...
export default class NextNodeServer extends BaseServer {
    constructor(options) {
        ...
        this.handleNextImageRequest = async (req, res, parsedUrl) => {
            ...
            if (this.minimalMode ||
                ...
                try {
                    ...
                    if (((_a = cacheEntry === null || cacheEntry === void 0 ? void 0 : cacheEntry.value) === null || _a === void 0 ? void 0 : _a.kind) !== 'IMAGE') {
        ...
        this.handleCatchallRenderRequest = async (req, res, parsedUrl) => {
            ...
            try {
                ...
                const options = {
                    i18n: (_a = this.i18nProvider) === null || _a === void 0 ? void 0 : _a.fromQuery(pathname, query),
                };
        ...
        if (!options.dev) {
            const { dynamicRoutes = [] } = (_a = this.getRoutesManifest()) !== null && _a !== void 0 ? _a : {};
    ...
    async prepareImpl() {
        ...
        if (!this.serverOptions.dev &&
            ...
            try {
                ...
                await ((_a = instrumentationHook.register) === null || _a === void 0 ? void 0 : _a.call(instrumentationHook));
            }
            catch (err) {
    ...
    loadEnvConfig({ dev, forceReload, silent, }) {
        loadEnvConfig(this.dir, dev, silent ? { info: () => { }, error: () => { } } : Log, forceReload);
    }
    ...
    async hasPage(pathname) {
        var _a;
        return !!getMaybePagePath(pathname, this.distDir, (_a = this.nextConfig.i18n) === null || _a === void 0 ? void 0 : _a.locales, this.enabledDirectories.app);
    }
    getBuildId() {
    ...
    async runApi(req, res, query, match) {
        ...
        query = Object.assign(Object.assign({}, query), match.params);
    ...
    async imageOptimizer(req, res, paramsResult) {
        if (process.env.NEXT_MINIMAL) {
            ...
            const imageUpstream = isAbsolute
                ...
                : await fetchInternalImage(href, req.originalRequest, res.originalResponse, handleInternalReq);
    ...
    async findPageComponentsImpl({ page, query, params, isAppPath, url: _url, }) {
        ...
        for (const pagePath of pagePaths) {
            try {
                ...
                return {
                    components,
                    query: Object.assign(Object.assign({}, (!this.renderOpts.isExperimentalCompile &&
    ...
    makeRequestHandler() {
        ...
        return (req, res, parsedUrl) => {
            ...
            const loggingFetchesConfig = (_a = this.nextConfig.logging) === null || _a === void 0 ? void 0 : _a.fetches;
            const enabledVerboseLogging = !!loggingFetchesConfig;
            const shouldTruncateUrl = !(loggingFetchesConfig === null || loggingFetchesConfig === void 0 ? void 0 : loggingFetchesConfig.fullUrl);
            if (this.renderOpts.dev) {
                ...
                const reqCallback = () => {
                    ...
                    if (normalizedReq.didInvokePath ||
    ...
    async revalidate({ urlPath, revalidateHeaders, opts, }) {
        ...
        if (mocked.res.getHeader('x-nextjs-cache') !== 'REVALIDATED' &&
    ...
    getMiddleware() {
        ...
        const middleware = (_a = manifest === null || manifest === void 0 ? void 0 : manifest.middleware) === null || _a === void 0 ? void 0 : _a['/'];
        if (!middleware) {
            return;
        }
        return {
    ...
    getEdgeFunctionInfo(params) {
        ...
        return {
            ...
            wasm: ((_a = pageInfo.wasm) !== null && _a !== void 0 ? _a : []).map((binding) => (Object.assign(Object.assign({}, binding), { filePath: join(this.distDir, binding.filePath) }))),
            assets: ((_b = pageInfo.assets) !== null && _b !== void 0 ? _b : []).map((binding) => {
                return Object.assign(Object.assign({}, binding), { filePath: join(this.distDir, binding.filePath) });
            }),
        };
    }
    /**
    ...
    async runMiddleware(params) {
        ...
        if (checkIsOnDemandRevalidate(params.request, this.renderOpts.previewProps)
    ...
    getPrerenderManifest() {
        ...
        if (((_a = this.renderOpts) === null || _a === void 0 ? void 0 : _a.dev) ||
            ((_b = this.serverOptions) === null || _b === void 0 ? void 0 : _b.dev) ||
    ...
    getRoutesManifest() {
        return getTracer().trace(NextNodeServerSpan.getRoutesManifest, () => {
            ...
            let rewrites = (_a = manifest.rewrites) !== null && _a !== void 0 ? _a : {
                beforeFiles: [],
                afterFiles: [],
                fallback: [],
            };
            ...
            return Object.assign(Object.assign({}, manifest), { rewrites });
        });
    }
    attachRequestMeta(req, parsedUrl, isUpgradeReq) {
        ...
        addRequestMeta(req, 'initQuery', Object.assign({}, parsedUrl.query));
    ...
    async runEdgeFunction(params) {
        ...
        const queryString = urlQueryToSearchParams(Object.assign(Object.assign(Object.assign({}, Object.fromEntries(initialUrl.searchParams)), query), params.params)).toString();
        if (isDataReq) {
        ...
        const result = await run({
            ...
            request: {
                ...
                url,
                page: Object.assign({ name: params.page }, (params.params && { params: params.params })),
