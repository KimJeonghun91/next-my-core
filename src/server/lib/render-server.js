...
export function clearModuleContext(target) {
    return sandboxContext === null || sandboxContext === void 0 ? void 0 : sandboxContext.clearModuleContext(target);
}
export function deleteAppClientCache() {
    return requireCacheHotReloader === null || requireCacheHotReloader === void 0 ? void 0 : requireCacheHotReloader.deleteAppClientCache();
}
export function deleteCache(filePaths) {
    for (const filePath of filePaths) {
        requireCacheHotReloader === null || requireCacheHotReloader === void 0 ? void 0 : requireCacheHotReloader.deleteCache(filePath);
    }
}
...
async function initializeImpl(opts) {
    ...
    let requestHandler;
    let upgradeHandler;
    const app = next(Object.assign(Object.assign({}, opts), { hostname: opts.hostname || 'localhost', customServer: false, httpServer: opts.server, port: opts.port, isNodeDebugging: opts.isNodeDebugging }));
