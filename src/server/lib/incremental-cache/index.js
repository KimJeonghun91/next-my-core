...
export class IncrementalCache {
    constructor({ fs, dev, appDir, pagesDir, flushToDisk, fetchCache, minimalMode, serverDistDir, requestHeaders, requestProtocol, maxMemoryCacheSize, getPrerenderManifest, fetchCacheKeyPrefix, CurCacheHandler, allowedRevalidateHeaderKeys, experimental, }) {
        ...
        if (!CurCacheHandler) {
            ...
            if (FetchCache.isAvailable({ _requestHeaders: requestHeaders }) &&
                minimalMode &&
                fetchCache) {
                if (debug) {
        ...
        let revalidatedTags = [];
        if (requestHeaders[PRERENDER_REVALIDATE_HEADER] ===
            ((_b = (_a = this.prerenderManifest) === null || _a === void 0 ? void 0 : _a.preview) === null || _b === void 0 ? void 0 : _b.previewModeId)) {
        ...
        if (minimalMode &&
            ...
            requestHeaders[NEXT_CACHE_REVALIDATE_TAG_TOKEN_HEADER] ===
                ((_d = (_c = this.prerenderManifest) === null || _c === void 0 ? void 0 : _c.preview) === null || _d === void 0 ? void 0 : _d.previewModeId)) {
            revalidatedTags =
    ...
    resetRequestCache() {
        var _a, _b;
        (_b = (_a = this.cacheHandler) === null || _a === void 0 ? void 0 : _a.resetRequestCache) === null || _b === void 0 ? void 0 : _b.call(_a);
    }
    ...
    async lock(cacheKey) {
        if (process.env.__NEXT_INCREMENTAL_CACHE_IPC_PORT &&
    ...
    async revalidateTag(tag) {
        ...
        return (_b = (_a = this.cacheHandler) === null || _a === void 0 ? void 0 : _a.revalidateTag) === null || _b === void 0 ? void 0 : _b.call(_a, tag);
    }
    ...
    async get(cacheKey, ctx = {}) {
        ...
        const cacheData = await ((_a = this.cacheHandler) === null || _a === void 0 ? void 0 : _a.get(cacheKey, ctx));
        if (((_b = cacheData === null || cacheData === void 0 ? void 0 : cacheData.value) === null || _b === void 0 ? void 0 : _b.kind) === 'FETCH') {
            const combinedTags = [...(ctx.tags || []), ...(ctx.softTags || [])];
            // if a tag was revalidated we don't return stale data
            if (combinedTags.some((tag) => {
                var _a;
                return (_a = this.revalidatedTags) === null || _a === void 0 ? void 0 : _a.includes(tag);
            })) {
                return null;
            }
        ...
        const curRevalidate = (_c = this.prerenderManifest.routes[toRoute(cacheKey)]) === null || _c === void 0 ? void 0 : _c.initialRevalidateSeconds;
        let isStale;
        let revalidateAfter;
        if ((cacheData === null || cacheData === void 0 ? void 0 : cacheData.lastModified) === -1) {
            isStale = -1;
            revalidateAfter = -1 * CACHE_ONE_YEAR;
        }
        else {
            revalidateAfter = this.calculateRevalidate(cacheKey, (cacheData === null || cacheData === void 0 ? void 0 : cacheData.lastModified) || Date.now(), this.dev && ctx.kindHint !== 'fetch');
            isStale =
    ...
    async set(pathname, data, ctx) {
        ...
        try {
            ...
            await ((_a = this.cacheHandler) === null || _a === void 0 ? void 0 : _a.set(pathname, data, ctx));
        }
        catch (error) {
