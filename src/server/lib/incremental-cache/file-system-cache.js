...
export default class FileSystemCache {
        ...
        if (ctx.maxMemoryCacheSize && !memoryCache) {
            ...
            memoryCache = new LRUCache({
                ...
                length({ value }) {
                    ...
                    return (value.html.length + (((_a = JSON.stringify(value.pageData)) === null || _a === void 0 ? void 0 : _a.length) || 0));
                },
            });
        }
        else if (this.debug) {
    ...
    async get(...args) {
        ...
        let data = memoryCache === null || memoryCache === void 0 ? void 0 : memoryCache.get(key);
        if (this.debug) {
        ...
        if (!data && process.env.NEXT_RUNTIME !== 'edge') {
            ...
            try {
                ...
                if (kind === 'fetch' && this.flushToDisk) {
                    ...
                    if (((_a = data.value) === null || _a === void 0 ? void 0 : _a.kind) === 'FETCH') {
                        const storedTags = (_b = data.value) === null || _b === void 0 ? void 0 : _b.tags;
                        // update stored tags if a new one is being added
                        // TODO: remove this when we can send the tags
                        // via header on GET same as SET
                        if (!(tags === null || tags === void 0 ? void 0 : tags.every((tag) => storedTags === null || storedTags === void 0 ? void 0 : storedTags.includes(tag)))) {
                            if (this.debug) {
                    ...
                    const pageData = isAppPath
                        ? await this.fs.readFile(this.getFilePath(`${key}${this.experimental.ppr ? RSC_PREFETCH_SUFFIX : RSC_SUFFIX}`, 'app'), 'utf8')
                        : JSON.parse(await this.fs.readFile(this.getFilePath(`${key}${NEXT_DATA_SUFFIX}`, 'pages'), 'utf8'));
                    let meta;
                    if (isAppPath) {
                        try {
                    ...
                    data = {
                        ...
                        value: {
                            ...
                            html: fileData,
                            pageData,
                            postponed: meta === null || meta === void 0 ? void 0 : meta.postponed,
                            headers: meta === null || meta === void 0 ? void 0 : meta.headers,
                            status: meta === null || meta === void 0 ? void 0 : meta.status,
                        },
                    };
                }
                if (data) {
                    memoryCache === null || memoryCache === void 0 ? void 0 : memoryCache.set(key, data);
                }
            }
            catch (_) {
        ...
        if (((_c = data === null || data === void 0 ? void 0 : data.value) === null || _c === void 0 ? void 0 : _c.kind) === 'PAGE') {
            let cacheTags;
            const tagsHeader = (_d = data.value.headers) === null || _d === void 0 ? void 0 : _d[NEXT_CACHE_TAGS_HEADER];
            if (typeof tagsHeader === 'string') {
                cacheTags = tagsHeader.split(',');
            }
            if (cacheTags === null || cacheTags === void 0 ? void 0 : cacheTags.length) {
                this.loadTagsManifest();
                const isStale = cacheTags.some((tag) => {
                    var _a;
                    return (((_a = tagsManifest === null || tagsManifest === void 0 ? void 0 : tagsManifest.items[tag]) === null || _a === void 0 ? void 0 : _a.revalidatedAt) &&
                        (tagsManifest === null || tagsManifest === void 0 ? void 0 : tagsManifest.items[tag].revalidatedAt) >=
                            ((data === null || data === void 0 ? void 0 : data.lastModified) || Date.now()));
                });
        ...
        if (data && ((_e = data === null || data === void 0 ? void 0 : data.value) === null || _e === void 0 ? void 0 : _e.kind) === 'FETCH') {
            this.loadTagsManifest();
    ...
    async set(...args) {
        ...
        memoryCache === null || memoryCache === void 0 ? void 0 : memoryCache.set(key, {
            value: data,
        ...
        if (!this.flushToDisk)
            return;
        if ((data === null || data === void 0 ? void 0 : data.kind) === 'ROUTE') {
            const filePath = this.getFilePath(`${key}.body`, 'app');
        ...
        if ((data === null || data === void 0 ? void 0 : data.kind) === 'PAGE') {
            ...
            await this.fs.writeFile(this.getFilePath(`${key}${isAppPath
                ? this.experimental.ppr
                    ? RSC_PREFETCH_SUFFIX
                    : RSC_SUFFIX
                : NEXT_DATA_SUFFIX}`, isAppPath ? 'app' : 'pages'), isAppPath ? data.pageData : JSON.stringify(data.pageData));
        ...
        else if ((data === null || data === void 0 ? void 0 : data.kind) === 'FETCH') {
            const filePath = this.getFilePath(key, 'fetch');
            await this.fs.mkdir(path.dirname(filePath));
            await this.fs.writeFile(filePath, JSON.stringify(Object.assign(Object.assign({}, data), { tags: ctx.tags })));
        }
    }
