...
export class MockedResponse extends Stream.Writable {
    constructor(res = {}) {
         ...
         */
        this.buffers = [];
        this.statusCode = (_a = res.statusCode) !== null && _a !== void 0 ? _a : 200;
        this.socket = (_b = res.socket) !== null && _b !== void 0 ? _b : null;
        ...
        this.hasStreamed = new Promise((resolve, reject) => {
            ...
            var _a;
            (_a = this.headPromiseResolve) === null || _a === void 0 ? void 0 : _a.call(this);
            return val;
        });
        if (res.resWriter) {
