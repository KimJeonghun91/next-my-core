...
export function getResolveRoutes(fsChecker, config, opts, renderServer, renderServerOpts, ensureMiddleware) {
    ...
    async function resolveRoutes({ req, res, isUpgradeReq, invokedOutputs, }) {
        ...
        const protocol = ((_a = req === null || req === void 0 ? void 0 : req.socket) === null || _a === void 0 ? void 0 : _a.encrypted) ||
        ...
        if (config.i18n) {
            const hadTrailingSlash = (_b = parsedUrl.pathname) === null || _b === void 0 ? void 0 : _b.endsWith('/');
            ...
            defaultLocale = (domainLocale === null || domainLocale === void 0 ? void 0 : domainLocale.defaultLocale) || config.i18n.defaultLocale;
            ...
            if (!initialLocaleResult.detectedLocale &&
                ...
                parsedUrl.pathname = addPathPrefix(initialLocaleResult.pathname === '/'
                    ? `/${defaultLocale}`
                    : addPathPrefix(initialLocaleResult.pathname || '', `/${defaultLocale}`), hadBasePath ? config.basePath : '');
                if (hadTrailingSlash) {
        ...
        const checkLocaleApi = (pathname) => {
            if (config.i18n &&
                pathname === urlNoQuery &&
                (initialLocaleResult === null || initialLocaleResult === void 0 ? void 0 : initialLocaleResult.detectedLocale) &&
        ...
        async function checkTrue() {
            ...
            if (!(invokedOutputs === null || invokedOutputs === void 0 ? void 0 : invokedOutputs.has(pathname))) {
                const output = await fsChecker.getItem(pathname);
                if (output) {
                    if (config.useFileSystemPublicRoutes ||
                        didRewrite ||
            ...
            if (config.basePath) {
                ...
                curPathname = (curPathname === null || curPathname === void 0 ? void 0 : curPathname.substring(config.basePath.length)) || '/';
            }
            ...
            for (const route of dynamicRoutes) {
                ...
                if (invokedOutputs === null || invokedOutputs === void 0 ? void 0 : invokedOutputs.has(route.page)) {
                    continue;
                }
                ...
                if (params) {
                    ...
                    if ((pageOutput === null || pageOutput === void 0 ? void 0 : pageOutput.type) === 'appFile' &&
                        (initialLocaleResult === null || initialLocaleResult === void 0 ? void 0 : initialLocaleResult.detectedLocale)) {
                        continue;
                    }
                    if (pageOutput && (curPathname === null || curPathname === void 0 ? void 0 : curPathname.startsWith('/_next/data'))) {
        ...
        async function handleRoute(route) {
            ...
            if (params) {
                ...
                if (route.name === 'middleware_next_data' && parsedUrl.pathname) {
                    if ((_a = fsChecker.getMiddlewareMatchers()) === null || _a === void 0 ? void 0 : _a.length) {
                        let normalized = parsedUrl.pathname;
                        // Remove the base path if it exists.
                        const hadBasePath = (_b = normalizers.basePath) === null || _b === void 0 ? void 0 : _b.match(parsedUrl.pathname);
                        ...
                        else if ((_c = normalizers.postponed) === null || _c === void 0 ? void 0 : _c.match(normalized)) {
                            updated = true;
                ...
                if (route.name === 'check_fs') {
                    const pathname = parsedUrl.pathname || '';
                    if ((invokedOutputs === null || invokedOutputs === void 0 ? void 0 : invokedOutputs.has(pathname)) || checkLocaleApi(pathname)) {
                        return;
                    }
                    const output = await fsChecker.getItem(pathname);
                    if (output &&
                ...
                if (!opts.minimalMode && route.name === 'middleware') {
                    ...
                    match === null || match === void 0 ? void 0 : match(parsedUrl.pathname, req, parsedUrl.query)) {
                        if (ensureMiddleware) {
                            await ensureMiddleware(req.url);
                        }
                        const serverResult = await (renderServer === null || renderServer === void 0 ? void 0 : renderServer.initialize(renderServerOpts));
                        if (!serverResult) {
                        ...
                        for (const [key, value] of Object.entries(Object.assign({}, filterReqHeaders(middlewareHeaders, ipcForbiddenHeaders)))) {
                            if ([
                                'content-length',
                ...
                // handle redirect
                if (('statusCode' in route || 'permanent' in route) &&
                    route.destination) {
