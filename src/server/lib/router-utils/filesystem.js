...
export const buildCustomRoute = (type, item, basePath, caseSensitive) => {
    ...
    const match = getPathMatch(item.source, {
        ...
        regexModifier: !item.internal
            ? (regex) => modifyRouteRegex(regex, type === 'redirect' ? restrictedRedirectPaths : undefined)
            : undefined,
        sensitive: caseSensitive,
    });
    return Object.assign(Object.assign(Object.assign({}, item), (type === 'rewrite' ? { check: true } : {})), { match });
};
export async function setupFsCheck(opts) {
    ...
    const getItemsLru = !opts.dev
        ? new LRUCache({
            ...
            length(value, key) {
                if (!value)
                    return (key === null || key === void 0 ? void 0 : key.length) || 0;
                return ((key || '').length +
                    (value.fsPath || '').length +
    ...
    if (!opts.dev) {
        ...
        try {
            ...
            if (opts.config.output !== 'standalone')
                throw err;
        }
        ...
        for (const route of routesManifest.dataRoutes) {
            if (isDynamicRoute(route.page)) {
                ...
                dynamicRoutes.push(Object.assign(Object.assign({}, route), { regex: routeRegex.re.toString(), match: getRouteMatcher({
                        // TODO: fix this in the manifest itself, must also be fixed in
                        // upstream builder that relies on this
                        re: opts.config.i18n
                            ? new RegExp(route.dataRouteRegex.replace(`/${escapedBuildId}/`, `/${escapedBuildId}/(?<nextLocale>[^/]+?)/`))
        ...
        for (const route of routesManifest.dynamicRoutes) {
            dynamicRoutes.push(Object.assign(Object.assign({}, route), { match: getRouteMatcher(getRouteRegex(route.page)) }));
        }
        if ((_b = (_a = middlewareManifest.middleware) === null || _a === void 0 ? void 0 : _a['/']) === null || _b === void 0 ? void 0 : _b.matchers) {
            middlewareMatcher = getMiddlewareRouteMatcher((_d = (_c = middlewareManifest.middleware) === null || _c === void 0 ? void 0 : _c['/']) === null || _d === void 0 ? void 0 : _d.matchers);
        }
        customRoutes = {
    ...
    return {
        ...
        async getItem(itemPath) {
            ...
            const lruResult = getItemsLru === null || getItemsLru === void 0 ? void 0 : getItemsLru.get(itemKey);
            if (lruResult) {
                return lruResult;
            }
            ...
            // requests.
            if (opts.minimalMode) {
                if ((_a = normalizers.prefetchRSC) === null || _a === void 0 ? void 0 : _a.match(itemPath)) {
                ...
                else if ((_b = normalizers.postponed) === null || _b === void 0 ? void 0 : _b.match(itemPath)) {
            ...
            for (let [items, type] of itemsToCheck) {
                ...
                if (i18n) {
                    ...
                    isDynamicOutput
                        ...
                        : [
                            ...
                            ...(((_c = i18n.domains) === null || _c === void 0 ? void 0 : _c.map((item) => item.defaultLocale)) || []),
                        ]);
                ...
                if (matchedItem || opts.dev) {
                            ...
                            if (ensureFn &&
                                (await ((_d = ensureFn({
                                    ...
                                    itemPath: isAppFile
                                        ...
                                        : curItemPath,
                                })) === null || _d === void 0 ? void 0 : _d.catch(() => 'ENSURE_FAILED'))) === 'ENSURE_FAILED') {
                                continue;
                            }
                        }
                        else {
                    ...
                    if (type === 'appFile' && locale && locale !== (i18n === null || i18n === void 0 ? void 0 : i18n.defaultLocale)) {
                        continue;
                    }
                    const itemResult = {
                        type,
                    ...
                    getItemsLru === null || getItemsLru === void 0 ? void 0 : getItemsLru.set(itemKey, itemResult);
                    return itemResult;
                }
            }
            getItemsLru === null || getItemsLru === void 0 ? void 0 : getItemsLru.set(itemKey, null);
            return null;
        },
        getDynamicRoutes() {
