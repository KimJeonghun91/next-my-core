...
const serverLayer = {
    ...
    filterCompletionsAtPosition(entries) {
        return entries.filter((e) => {
            ...
            if (DISALLOWED_SERVER_REACT_APIS.includes(e.name) &&
                e.source === 'react') {
                return false;
            }
            return true;
    ...
    hasDisallowedReactAPIDefinition(definitions) {
        return definitions === null || definitions === void 0 ? void 0 : definitions.some((d) => DISALLOWED_SERVER_REACT_APIS.includes(d.name) &&
