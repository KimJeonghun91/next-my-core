...
const API_DOCS = {
    ...
    preferredRegion: {
        ...
        getHint: (value) => {
            if (value === 'auto')
                return `Automatically chosen by Next.js.`;
            if (value === 'global')
                return `Prefer deploying globally.`;
            if (value === 'home')
                return `Prefer deploying to the Home region.`;
            if (Array.isArray(value))
                return `Deploy to regions: ${value.join(', ')}.`;
            if (typeof value === 'string')
                return `Deploy to region: ${value}.`;
        },
    },
    revalidate: {
        ...
        visitEntryConfig(fileName, position, (entryConfig, declaration) => {
            ...
            if (value && isPositionInsideNode(position, value)) {
                ...
                const isValid = API_DOCS[entryConfig].isValid
                    ? (_b = (_a = API_DOCS[entryConfig]).isValid) === null || _b === void 0 ? void 0 : _b.call(_a, key)
                    : !!((_c = API_DOCS[entryConfig].options) === null || _c === void 0 ? void 0 : _c[key]);
                if (isValid) {
                    overridden = {
                        ...
                        documentation: [
                            {
                                kind: 'text',
                                text: ((_d = API_DOCS[entryConfig].options) === null || _d === void 0 ? void 0 : _d[key]) ||
                                    ((_f = (_e = API_DOCS[entryConfig]).getHint) === null || _f === void 0 ? void 0 : _f.call(_e, key)) ||
                                    '',
                            },
                            docsLink,
                        ],
                        ...
                        if (value && options) {
                            ...
                            if (ts.isStringLiteral(value) ||
                                ...
                                if (!allowedValues.includes(val) &&
                                    !((_b = (_a = API_DOCS[name.text]).isValid) === null || _b === void 0 ? void 0 : _b.call(_a, val))) {
                                    isInvalid = true;
                                    displayedValue = val;
                                }
                            }
                                ...
                                (ts.isPrefixUnaryExpression(value) &&
                                    ts.isMinusToken(value.operator) &&
                                    (ts.isNumericLiteral(value.operand.kind) ||
                                        (ts.isIdentifier(value.operand.kind) &&
                                            value.operand.kind.getText() === 'Infinity'))) ||
                                (ts.isIdentifier(value) && value.getText() === 'Infinity')) {
                                const v = value.getText();
                                if (!((_d = (_c = API_DOCS[name.text]).isValid) === null || _d === void 0 ? void 0 : _d.call(_c, v))) {
                                    isInvalid = true;
                                    displayedValue = v;
                                }
                            }
                                ...
                                const v = value.getText();
                                if (!((_f = (_e = API_DOCS[name.text]).isValid) === null || _f === void 0 ? void 0 : _f.call(_e, v))) {
                                    isInvalid = true;
                                    displayedValue = v;
                                }
                            }
                                ...
                                const v = value.getText();
                                if (!((_h = (_g = API_DOCS[name.text]).isValid) === null || _h === void 0 ? void 0 : _h.call(_g, JSON.stringify(value.elements.map((e) => e.getText()))))) {
                                    isInvalid = true;
                                    displayedValue = v;
                                }
                            }
