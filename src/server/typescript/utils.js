...
export function getTypeChecker() {
    var _a;
    return (_a = info.languageService.getProgram()) === null || _a === void 0 ? void 0 : _a.getTypeChecker();
}
export function getSource(fileName) {
    var _a;
    return (_a = info.languageService.getProgram()) === null || _a === void 0 ? void 0 : _a.getSourceFile(fileName);
}
