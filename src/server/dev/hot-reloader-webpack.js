...
export default class HotReloaderWebpack {
    ...
    onHMR(req, _socket, head) {
        wsServer.handleUpgrade(req, req.socket, head, (client) => {
            var _a, _b;
            (_a = this.webpackHotMiddleware) === null || _a === void 0 ? void 0 : _a.onHMR(client);
            (_b = this.onDemandEntries) === null || _b === void 0 ? void 0 : _b.onHMR(client, () => this.hmrServerError);
            client.addEventListener('message', ({ data }) => {
                ...
                try {
                    ...
                    switch (payload.event) {
                        case 'span-end': {
                            new Span({
                                ...
                                startTime: BigInt(Math.floor(payload.startTime)) *
                                    BigInt(MILLISECONDS_IN_NANOSECOND),
                                attrs: payload.attributes,
                            }).stop(BigInt(Math.floor(payload.endTime)) *
                                BigInt(MILLISECONDS_IN_NANOSECOND));
                            break;
                        }
                        case 'client-hmr-latency': {
                            traceChild = {
                                name: payload.event,
                                startTime: BigInt(payload.startTime) *
                                    BigInt(MILLISECONDS_IN_NANOSECOND),
                        ...
                        case 'client-full-reload': {
                            ...
                            traceChild = {
                                name: event,
                                attrs: { stackTrace: stackTrace !== null && stackTrace !== void 0 ? stackTrace : '' },
                            };
                            if (hadRuntimeError) {
                            ...
                            let fileMessage = '';
                            if (stackTrace) {
                                const file = (_a = /Aborted because (.+) is not accepted/.exec(stackTrace)) === null || _a === void 0 ? void 0 : _a[1];
                                if (file) {
                    ...
                    if (traceChild) {
                        this.hotReloaderSpan.manualTraceChild(traceChild.name, traceChild.startTime || process.hrtime.bigint(), traceChild.endTime || process.hrtime.bigint(), Object.assign(Object.assign({}, traceChild.attrs), { clientId: payload.id }));
                    }
                }
                catch (_) {
    ...
    async clean(span) {
        return span
            .traceChild('clean')
            .traceAsyncFn(() => recursiveDelete(join(this.dir, this.config.distDir), /^cache/));
    }
    ...
    async getWebpackConfig(span) {
        ...
        return webpackConfigSpan.traceAsyncFn(async () => {
            ...
            const entrypoints = await webpackConfigSpan
                ...
                .traceAsyncFn(() => createEntrypoints({
                appDir: this.appDir,
            ...
            return webpackConfigSpan
                ...
                return Promise.all([
                    ...
                    getBaseWebpackConfig(this.dir, Object.assign(Object.assign(Object.assign({}, commonWebpackOptions), { compilerType: COMPILER_NAMES.client, entrypoints: entrypoints.client }), info)),
                    getBaseWebpackConfig(this.dir, Object.assign(Object.assign(Object.assign({}, commonWebpackOptions), { compilerType: COMPILER_NAMES.server, entrypoints: entrypoints.server }), info)),
                    getBaseWebpackConfig(this.dir, Object.assign(Object.assign(Object.assign({}, commonWebpackOptions), { compilerType: COMPILER_NAMES.edgeServer, entrypoints: entrypoints.edgeServer }), info)),
                ]);
            });
        });
    }
    async buildFallbackError() {
        ...
        const fallbackConfig = await getBaseWebpackConfig(this.dir, Object.assign({ runWebpackSpan: this.hotReloaderSpan, dev: true, compilerType: COMPILER_NAMES.client, config: this.config, buildId: this.buildId, pagesDir: this.pagesDir, rewrites: {
                beforeFiles: [],
                afterFiles: [],
                fallback: [],
            }, originalRewrites: {
                ...
                afterFiles: [],
                fallback: [],
            }, originalRedirects: [], isDevFallback: true, entrypoints: (await createEntrypoints({
                appDir: this.appDir,
                buildId: this.buildId,
                config: this.config,
                envFiles: [],
    ...
    async start() {
        ...
        for (const config of this.activeWebpackConfigs) {
            ...
            config.entry = async (...args) => {
                var _a;
                const outputPath = ((_a = this.multiCompiler) === null || _a === void 0 ? void 0 : _a.outputPath) || '';
                ...
                await Promise.all(Object.keys(entries).map(async (entryKey) => {
                    ...
                    if (key === COMPILER_NAMES.client && !isClientCompilation)
                        return;
                    ...
                    runDependingOnPageType({
                        ...
                        onEdgeServer: () => {
                            ...
                            if (!isEdgeServerCompilation || !isEntry)
                                return;
                        ...
                        onServer: () => {
                            ...
                            if (isAppPath) {
                                ...
                                value = getRouteLoaderEntry({
                                    ...
                                    absolutePagePath: relativeRequest,
                                    preferredRegion: staticInfo.preferredRegion,
                                    middlewareConfig: (_a = staticInfo.middleware) !== null && _a !== void 0 ? _a : {},
                                });
                            }
                            else {
                                ...
                                modsIterable.forEach((mod) => {
                                    ...
                                    if (mod.resource &&
                                        ...
                                        if (mod.layer === WEBPACK_LAYERS.reactServerComponents &&
                                            ((_b = (_a = mod === null || mod === void 0 ? void 0 : mod.buildInfo) === null || _a === void 0 ? void 0 : _a.rsc) === null || _b === void 0 ? void 0 : _b.type) !== 'client') {
                                        ...
                                        if (mod.layer === WEBPACK_LAYERS.reactServerComponents &&
                                            ((_d = (_c = mod === null || mod === void 0 ? void 0 : mod.buildInfo) === null || _c === void 0 ? void 0 : _c.rsc) === null || _d === void 0 ? void 0 : _d.type) !== 'client') {
                                            chunksHashServerLayer.add(hash);
                                        }
                                        chunksHash.add(hash);
        ...
        this.multiCompiler.hooks.done.tap('NextjsHotReloaderForServer', () => {
            ...
            if (changedServerComponentPages.size ||
        ...
        this.watcher = await new Promise((resolve) => {
            var _a;
            const watcher = (_a = this.multiCompiler) === null || _a === void 0 ? void 0 : _a.watch(
            // @ts-ignore webpack supports an array of watchOptions when using a multiCompiler
        ...
        this.onDemandEntries = onDemandEntryHandler(Object.assign({ hotReloader: this, multiCompiler: this.multiCompiler, pagesDir: this.pagesDir, appDir: this.appDir, rootDir: this.dir, nextConfig: this.config }, this.config.onDemandEntries));
        this.interceptors = [
    ...
    invalidate({ reloadAfterInvalidation } = {
        ...
        const outputPath = (_a = this.multiCompiler) === null || _a === void 0 ? void 0 : _a.outputPath;
        return outputPath && ((_b = getInvalidator(outputPath)) === null || _b === void 0 ? void 0 : _b.invalidate());
    }
    async stop() {
        await new Promise((resolve, reject) => {
    ...
    async getCompilationErrors(page) {
        ...
        const getErrors = ({ compilation }) => {
            ...
            return ((_a = failedPages[normalizedPage]) === null || _a === void 0 ? void 0 : _a.length) > 0
        ...
        else if ((_a = this.clientStats) === null || _a === void 0 ? void 0 : _a.hasErrors()) {
            return getErrors(this.clientStats);
        }
        else if ((_b = this.serverStats) === null || _b === void 0 ? void 0 : _b.hasErrors()) {
            return getErrors(this.serverStats);
        }
        else if ((_c = this.edgeServerStats) === null || _c === void 0 ? void 0 : _c.hasErrors()) {
    ...
    async ensurePage({ page, clientOnly, appPaths, definition, isApp, url, }) {
        ...
        return (_a = this.onDemandEntries) === null || _a === void 0 ? void 0 : _a.ensurePage({
            page,
            appPaths,
            definition,
            isApp,
