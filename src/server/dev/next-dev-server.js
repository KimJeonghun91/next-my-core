...
export default class DevServer extends Server {
    ...
    constructor(options) {
        ...
        super(Object.assign(Object.assign({}, options), { dev: true }));
        /**
        ...
        this.startServerSpan =
            (_a = options.startServerSpan) !== null && _a !== void 0 ? _a : trace('start-next-dev-server');
        this.storeGlobals();
        ...
        this.renderOpts.ampSkipValidation =
            (_d = (_c = (_b = this.nextConfig.experimental) === null || _b === void 0 ? void 0 : _b.amp) === null || _c === void 0 ? void 0 : _c.skipValidation) !== null && _d !== void 0 ? _d : false;
        this.renderOpts.ampValidator = (html, pathname) => {
            const validatorPath = this.nextConfig.experimental &&
                this.nextConfig.experimental.amp &&
                this.nextConfig.experimental.amp.validator;
            const AmpHtmlValidator = require('next/dist/compiled/amphtml-validator');
            return AmpHtmlValidator.getInstance(validatorPath).then((validator) => {
                const result = validator.validateString(html);
                ampValidation(pathname, result.errors
    ...
    async runMiddleware(params) {
        try {
            const result = await super.runMiddleware(Object.assign(Object.assign({}, params), { onWarning: (warn) => {
    ...
    async runEdgeFunction(params) {
        try {
            return super.runEdgeFunction(Object.assign(Object.assign({}, params), { onWarning: (warn) => {
                    this.logErrorWithOriginalStack(warn, 'warning');
                } }));
        }
        catch (error) {
    ...
    async handleRequest(req, res, parsedUrl) {
        ...
        const result = await span.traceAsyncFn(async () => {
            var _a;
            await ((_a = this.ready) === null || _a === void 0 ? void 0 : _a.promise);
    ...
    getPagesManifest() {
        var _a;
        return ((_a = NodeManifestLoader.require(pathJoin(this.serverDistDir, PAGES_MANIFEST))) !== null && _a !== void 0 ? _a : undefined);
    }
    getAppPathsManifest() {
        var _a;
        if (!this.enabledDirectories.app)
            return undefined;
        return ((_a = NodeManifestLoader.require(pathJoin(this.serverDistDir, APP_PATHS_MANIFEST))) !== null && _a !== void 0 ? _a : undefined);
    }
    getMiddleware() {
        var _a;
        // We need to populate the match
        // field as it isn't serializable
        if (((_a = this.middleware) === null || _a === void 0 ? void 0 : _a.match) === null) {
    ...
    async getStaticPaths({ pathname, requestHeaders, page, isAppPath, }) {
        ...
        const nextInvoke = withCoalescedInvoke(__getStaticPaths)(`staticPaths-${pathname}`, [])
            ...
            const value = {
                staticPaths,
                fallbackMode: fallback === 'blocking'
                    ? 'blocking'
                    : fallback === true
                        ? 'static'
                        : fallback,
    ...
    restorePatchedGlobals() {
        var _a;
        global.fetch = (_a = this.originalFetch) !== null && _a !== void 0 ? _a : global.fetch;
    }
